...
const DEFAULT_PRESETS = [
  ...
  },
  {
    ...
    message: "Take a picture and transform the subject into an elaborate crop circle design viewed from directly above. The subject's face, body, and features should be recreated as a massive intricate crop circle pattern in a wheat or grain field. Use flattened crops creating the design through contrast between standing golden grain and pressed-down darker paths forming the subject's likeness. The portrait should be recognizable from aerial view using geometric patterns, circles, lines, and curves typical of crop circle formations. Include authentic crop circle characteristics: precisely flattened grain stalks laid in swirled patterns, sharp edges between flattened and standing crops, multiple concentric circles, connecting pathways, sacred geometry elements. Show the massive scale - the crop circle should span hundreds of feet across the field. Use aerial photography perspective as if photographed from helicopter or drone, showing surrounding farmland, field boundaries, trees at edges, perhaps a road or farmhouse for scale reference. Include subtle details suggesting mysterious origin - perfectly geometric precision, overnight appearance. The lighting should be golden hour with long shadows emphasizing the depth and dimension of the flattened patterns. Add subtle alien/UFO mystique - maybe a distant light in sky or mysterious glow. Make it look like an actual aerial photograph of an unexplained crop circle formation that happens to perfectly depict the subject's portrait in massive field art."
  },
  {
  ...
  },
  {
    ...
    message: "Take a picture and transform the subject's face into a stylized mask while keeping their body and pose unchanged. The face should become a smooth, rigid mask surface - could be a Guy Fawkes/V for Vendetta style (white porcelain with black features, goatee, rosy cheeks, perpetual smile), traditional theatrical mask (Greek comedy/tragedy, Venetian carnival), horror mask (blank white face, emotionless), or cultural ceremonial mask (African tribal, Japanese Noh, Mexican Day of the Dead). The mask should replace the subject's face completely - smooth sculptural surface with painted or carved features, no skin texture, simplified facial features, fixed expression that doesn't change. Show the mask as a physical object worn on the face - visible edges where mask meets skin at hairline and jawline, slight shadow gap between mask and face, possible elastic strap or ties visible at sides. The mask material should be clearly defined - porcelain, plastic, wood, paper mache, or painted surface with slight sheen or matte finish. Preserve the subject's hair, clothing, body, and everything else exactly as in the original photo. The contrast between the artificial mask face and real human body should be obvious. Use lighting that emphasizes the mask's smooth surface and creates shadows in eye holes or carved features. Make it look photorealistic as if the subject is actually wearing a physical mask over their face."
  },
  {
    name: "RENAISSANCE",
    category: ["ART", "PAINTING", "CLASSIC"],
