...
const DEFAULT_PRESETS = [
  ...
  message: "Take a picture and transform it into a realistic lenticular print illusion.\n\nReconstruct the image as if printed on a physical lenticular sheet composed of fine vertical ridges. The image should suggest multiple interlaced views that change with viewing angle.\n\nCreate the illusion of depth or motion by subtly alternating between two or three related views of the subject (e.g., slight pose shift, expression change, or perspective change). These views should be visually interwoven, not separated into panels.\n\nVisible vertical lens lines must be present across the entire image, giving the unmistakable appearance of a lenticular plastic surface.\n\nDo NOT create a Magic Eye stereogram or red/blue anaglyph. This is not a stereo image but an angle-dependent illusion.\n\nLighting should reflect off the lenticular ridges with subtle highlights and glare, reinforcing the physicality of the print.\n\nThe final image should feel like a real lenticular card or poster photographed straight-on — slightly glossy, tactile, and clearly readable on a small screen."
  },
  {
    name: "LETTERHEAD",
