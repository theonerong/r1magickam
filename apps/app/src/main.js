...
const DEFAULT_PRESETS = [
  ...
  {
    name: "2D IN 3D",
    category: ["3D", "REALISM", "CINEMATIC", "DEPTH"],
    message: "Take a picture and reconstruct the scene as an extremely realistic 3D render with true perceptual depth.\n\nThe image must feel physically three-dimensional when viewed on a flat screen. Use real-world depth cues including parallax, occlusion, scale variation, cast shadows, contact shadows, depth layering, and realistic perspective.\n\nRender the subject and environment as fully volumetric forms, not flat cutouts or illustrations. Every object should have visible thickness, curvature, and spatial separation from other elements.\n\nUse cinematic lighting to enhance depth: key light, fill light, and rim light should define form and distance. Shadows must anchor objects to surfaces and reveal depth relationships.\n\nAllow subtle, realistic depth-of-field only where physically appropriate, never as an artistic blur. Foreground, midground, and background must be clearly separated in space.\n\nMaterials should be physically plausible (skin, fabric, metal, glass, wood) with accurate reflections, highlights, and surface response to light. Avoid painterly or stylized textures.\n\nCamera framing should emphasize depth — angled viewpoints, objects partially occluding others, and visible space between planes.\n\nDo NOT use stereoscopic effects, optical illusions, Magic Eye patterns, or split views. The depth must be readable naturally through composition and lighting alone.\n\nThe final image should feel like a high-end cinematic 3D render or VFX still — immersive, tangible, and convincingly three-dimensional, while remaining clear and readable on a small screen."
  },
  {
  ...
  {
    name: "HOLOGRAM ILLUSION",
    category: ["3D", "FUTURISTIC", "ILLUSION", "VOLUMETRIC"],
    message: "Take a picture and transform the subject into a hologram-like illusion.\n\nRender the subject as a semi-transparent, volumetric projection composed of light rather than solid matter. The subject should appear to float in space with visible depth and internal structure.\n\nUse layered transparency, light beams, scan lines, and subtle flicker to suggest an active projection. Edges may glow softly, but the form must remain readable and dimensional.\n\nApply a limited hologram palette such as cyan, teal, pale blue, violet, or mint green. Avoid full natural color rendering.\n\nIntroduce slight perspective shifts, internal parallax, or light refraction effects to reinforce the illusion of depth.\n\nDo NOT depict a physical solid object, statue, or neon sign. This must feel like light-based imagery suspended in space.\n\nOptionally include a subtle projector source, interface elements, or environmental lighting reacting to the hologram.\n\nThe final image should feel futuristic, ethereal, and convincingly three-dimensional while remaining clear on a small screen."
  },
  {
    name: "HOPPER",
  ...
  },
  {
    ...
    category: ["3D", "OPTICAL", "PRINT", "ILLUSION"],
    message: "Take a picture and reconstruct it as a realistic lenticular print that produces a visible 3D depth illusion.\n\nCreate multiple slightly different perspective views of the same scene (left, center, right viewpoints). These views must differ in spatial position, not just brightness or color. Foreground elements should shift noticeably between views, while background elements shift minimally.\n\nInterlace these views into narrow vertical bands across the entire image, simulating how lenticular lenses reveal different perspectives at different viewing angles. The banding must affect depth perception, not just surface texture.\n\nDepth illusion rules:\n• Foreground elements must appear to float forward relative to the background.\n• Midground elements should show moderate parallax.\n• Background elements should remain relatively stable.\n\nOverlay a subtle but visible lenticular lens surface: vertical ridges, glossy reflections, and slight specular highlights that imply a physical plastic lens sheet.\n\nDo NOT create a flat image with stripes. Do NOT create a Magic Eye stereogram or red/blue anaglyph. This must read as a single image that appears to shift in depth when imagined at different angles.\n\nLighting and shading must remain consistent across all views so the illusion reads as depth rather than motion.\n\nThe final image should look like a real lenticular card photographed straight-on — tactile, optical, and clearly three-dimensional even without glasses, and readable on a small screen."
  },
  {
    name: "LETTERHEAD",
