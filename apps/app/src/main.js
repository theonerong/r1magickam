...
const DEFAULT_PRESETS = [
  ...
  },
  {
    ...
    message: "Take a picture and transform it into a QR-code-like graphic where the image of the subject is only subtly discoverable through the distribution of QR-style modules.\n\nThe final image must read clearly as a QR code first. It should NOT resemble a photograph, illustration, portrait, or face at first glance. There must be no facial outlines, and no obvious subject placement.\n\nConstruct the entire image using a uniform grid of small, square, QR-style black-and-white modules. The subject must be encoded indirectly by extremely subtle changes in module density, spacing, or clustering across the grid.\n\nThe subject’s likeness should only become noticeable when viewed from a distance or after prolonged inspection, emerging as a vague impression rather than a clear image. Avoid sharp edges, facial features, eyes, mouths, or silhouettes. Recognition should feel accidental, not intentional.\n\nThe QR grid must remain visually dominant and continuous across the entire image.\n\nInclude QR-inspired structural elements such as finder squares or alignment blocks, but they must blend naturally into the overall pattern and never frame or highlight the subject.\n\nIf external master prompt text is provided, treat it as conceptual data influencing overall block density or noise rather than forming readable content.\n\nUse strict monochrome contrast, sharp edges, and consistent block sizing. The final result should feel like a legitimate QR code that just happens to hide an image within it — not a picture disguised as a QR code."
  },
  {
    name: "QUASI-MUTATION",
