...
const DEFAULT_PRESETS = [
  ...
  },
  {
    ...
    message: "Take a picture and transform the subject so it appears formed entirely from clouds.\n\nThe **overall cloud shape must follow the subject’s silhouette, posture, and proportions**. The subject’s outline governs the form. The subject must look like it has become a cloud, not like a cloud floating nearby.\n\nDetermine the cloud **type** based on the subject:\n• If the subject is animate (person or animal), select the cloud type based on the subject’s apparent emotion:\n  – Happy or playful → **Cumulus** (bright, puffy, well-defined)\n  – Sad, tired, or withdrawn → **Nimbostratus** (heavy, low, rain-filled)\n  – Angry, intense, or aggressive → **Cumulonimbus** (towering, dense, storm-like)\n  – Calm or neutral → **Stratus** (smooth, layered, subdued)\n• If the subject is inanimate, use **Altocumulus** clouds with a neutral, evenly spaced texture.\n\nUse cloud density, lighting, shadow, and internal contrast to express emotion while maintaining the subject’s recognizable silhouette. Facial features, limbs, or key contours should be implied through cloud volume and shading, not drawn outlines.\n\nAvoid solid ground unless contextually appropriate. Support the illusion with sky gradients, mist, or distant horizons.\n\nUse realistic atmospheric lighting and volumetric depth. Keep edges soft but the silhouette readable on a small screen. The final image should feel poetic and surreal, as if the subject briefly transformed into a specific type of weather."
  },
  {
    name: "COLLAGE",
