...
const DEFAULT_PRESETS = [
  ...
  },
  {
    ...
    message: "Take a picture and transform the subject into a bullfighter in a bullring.\n\nRandomize the scene between two modes:\n1. Serious: Subject confidently posing with a red cape while the bull is far away.\n2. Humorous: Subject has no idea a bull is charging toward them, while spectators are yelling and pointing in alarm.\n\nInclude a realistic bullring, audience, sand texture, and matador costume details. Preserve facial identity and expressions to match either serious or comedic tone."
  },
  {
    name: "BUMPER STICKER",
  ...
  },
  {
    ...
    category: ["FESTIVAL", "DANGER", "SPAIN", "SAN FERMIN"],
    message: "Take a picture and transform the subject into a participant in the Running of the Bulls festival in Pamplona, Spain. The subject is running in front of a charging bull about to be gored. Include cobblestone streets, festival spectators, and other runners.\n\nLighting, motion blur, and perspective must match real action photography. Emphasize tension and movement.\n\nDO NOT place the subject prominently or out of context — the scene should look chaotic and realistic, as if part of the festival."
  },
  {
