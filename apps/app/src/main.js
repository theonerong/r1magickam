...
const DEFAULT_PRESETS = [
  ...
  },
  {
    ...
    message: "Take a picture and transform the subject into a QR-code-style image where the subject’s face and features are constructed entirely from QR-code modules.\n\nThe subject must NOT appear as a normal photograph placed inside, behind, or over a QR code. There should be no photographic image visible at all. The face, silhouette, shading, and expression must emerge solely from the arrangement of black-and-white square QR-style blocks.\n\nThe final image must be a single, square QR-code-like graphic, fully visible, centered, and uncropped. The edges of the square must be intact. The code should appear printed or displayed on a flat surface such as paper, a screen, or a label.\n\nFrom a distance, the QR pattern should clearly resemble the subject’s face or head. From up close, it should read as a dense matrix of square modules with varying density used to create light and shadow.\n\nInclude subtle QR-inspired structural elements such as finder squares or alignment patterns, but ensure they are integrated into the overall composition rather than framing a photo.\n\nIf external master prompt text is provided, treat it as the conceptual ‘encoded data’ and allow it to influence block density, contrast, or pattern complexity.\n\nUse strict black-and-white or near-black-and-white contrast, sharp edges, and a clean, modern design aesthetic. The final result should feel clever, conceptual, and unmistakably made out of QR-code blocks rather than containing an image."
  },
  {
    name: "QUASI-MUTATION",
