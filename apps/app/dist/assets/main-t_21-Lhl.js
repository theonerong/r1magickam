(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function a(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(i){if(i.ep)return;i.ep=!0;const s=a(i);fetch(i.href,s)}})();let h,p,R,y,Dt,k=null,j=null;const Et=[{name:"VGA (640x480)",width:640,height:480},{name:"SVGA (800x600)",width:800,height:600},{name:"XGA (1024x768)",width:1024,height:768},{name:"SXGA (1280x960)",width:1280,height:960},{name:"SXGA+ (1400x1050)",width:1400,height:1050},{name:"UXGA (1600x1200)",width:1600,height:1200},{name:"2K (2048x1080)",width:2048,height:1080},{name:"4K (3840x2160)",width:3840,height:2160}];let ye=0;const di="r1_camera_resolution",va=[{name:"Auto",value:"auto"},{name:"Daylight",value:"daylight"},{name:"Cloudy",value:"cloudy"},{name:"Tungsten",value:"tungsten"},{name:"Fluorescent",value:"fluorescent"},{name:"Candlelight",value:"candlelight"},{name:"Moonlight",value:"moonlight"}];let $e=0;const hi="r1_camera_white_balance";let F=0,A=[],ua=!1,P=1,rt=!1,_n=0,$n=1,Re=!1,M=5,wt=500,ma=!1;const Qe={1:{delay:800,label:"Slow"},2:{delay:500,label:"Medium"},3:{delay:300,label:"Fast"}},ui="r1_camera_burst_settings",mi="r1_camera_timer_settings",gi="r1_camera_last_preset";let Oe=!1,be=null,de=10,We=!1,pi=[3,5,10],q=1;const fi={1:{seconds:1,label:"1s"},2:{seconds:3,label:"3s"},3:{seconds:5,label:"5s"},4:{seconds:10,label:"10s"},5:{seconds:30,label:"30s"},6:{seconds:60,label:"1m"},7:{seconds:300,label:"5m"},8:{seconds:600,label:"10m"},9:{seconds:1800,label:"30m"},10:{seconds:3600,label:"1h"}};let Z="",we=!1;const yi="r1_camera_master_prompt",bi="r1_camera_master_prompt_enabled",Ti="r1_camera_aspect_ratio";let G="none",Je=!1,ce=!1,xt=null,ge=null,Ze=30,ka=.1,ze=!0,et=2,Ct=!1,tt=3;const Ei="r1_camera_motion_settings";let ct=null;const mt={1:{seconds:3,label:"3s"},2:{seconds:10,label:"10s"},3:{seconds:30,label:"30s"},4:{seconds:60,label:"1m"},5:{seconds:300,label:"5m"},6:{seconds:600,label:"10m"},7:{seconds:900,label:"15m"},8:{seconds:1800,label:"30m"}};let H=!1;const wi="r1_camera_no_magic_mode";let Ke,ga,lt=null,U=0,N=!1,je=!1,he=!1,x=0,ee=0,te=0,D=!1,It=!1,qt=!1,Kt=!1,Jt=!1,Xt=!1,qe=!1,nt=!1,re=-1,ae=0;const Xi="R1CameraGallery",_i=1,Le="images";let $=null,L=[];const Ii="r1_gallery_sort_order";let J=-1,oe=1,Lt=!1,Qn=0,Zn=1,K=1;const Pt=16;let dt=null,ht=null,gt="newest",Ce=!1,S=new Set,_t=!1,Te=[],Ut=null,Ae="",Bt="",ba=0,He="",pe="",Fe="";const ei={transform:"Take a picture and transform the image into [DESCRIBE TRANSFORMATION]. [ADD SPECIFIC DETAILS ABOUT STYLE, APPEARANCE, COLORS, ETC.]",transform_subject:"Take a picture and transform the subject into [WHAT THE SUBJECT BECOMES]. Preserve the subject's recognizable facial structure and identity. [ADD DETAILS ABOUT NEW APPEARANCE, ENVIRONMENT, LIGHTING].",convert:"Take a picture and convert the scene into [DESCRIBE NEW FORMAT/MEDIUM]. [ADD DETAILS ABOUT MATERIALS, TEXTURES, SCALE].",style:"Take a picture in the style of [ARTISTIC STYLE/ARTIST]. [ADD DETAILS ABOUT TECHNIQUE, COLORS, COMPOSITION].",place:"Take a picture and place the subject in [DESCRIBE SCENE/LOCATION]. [ADD DETAILS ABOUT LIGHTING, ATMOSPHERE, INTEGRATION].",recreate:"Take a picture and recreate [FAMOUS WORK/SCENE]. Replace [DESCRIBE WHAT TO REPLACE]. Preserve the iconic [DESCRIBE KEY ELEMENTS TO KEEP].",render:"Take a picture and render it as [FORMAT/MEDIUM]. [ADD DETAILS ABOUT APPEARANCE, TEXTURE, TECHNICAL SPECIFICS].",make:"Take a picture and make the subject into [CHARACTER/CREATURE]. [ADD DETAILS ABOUT APPEARANCE, TRAITS, SETTING]. Make it photorealistic.",analyze:"Analyze the image and [DESCRIBE WHAT TO ANALYZE/EXTRACT]. [ADD DETAILS ABOUT OUTPUT FORMAT] and email it to me.",random:`Take a picture and [DESCRIBE BASE TRANSFORMATION].
...
• Do not reuse the same show across renders
• Options: Cats, Wicked, Phantom of the Opera, Book of Mormon, Hamilton, Chicago, Les Miserables, Oklahoma, A Chorus Line, Fiddler on the Roof, West Side Story, Mamma Mia, Rent, The Lion King, Jersey Boys, Dear Evan Hansen
...
• Do not reuse the same film across renders
• Options: Ghostbusters, Animal House, Caddyshack, Some Like it Hot, Blazing Saddles, Annie Hall, Planes Trains and Automobiles, The Hangover, Coming to America, Beverly Hills Cop, Trading Places, A Fish Called Wanda, Big Lebowski, Dazed and Confused, Wayne's World
...
• Do not reuse the same element across renders
• Options: fire, water, earth, wind, lightning
...
• Do not reuse the same festival across renders
• Options: La Tomatina (Spain) - tomato-slinging streets, Holi (India) - color powders thrown across crowds, Songkran Festival (Thailand) - water guns and hoses splashing, Battle of the Oranges (Italy) - teams throwing oranges, Belize Carnival - painting water eggs and flour with music and dancing, Boryeong Mud Festival (South Korea) - mud slides baths and playful activities
...
• Do not reuse the same scene across renders
• Options:
...
• Do not reuse the same distortion across renders
• Options: vertical concave (tall and pinched inward), vertical convex (short and wide), horizontal concave (squeezed side-to-side), horizontal convex (stretched side-to-side), concave-convex (pinched center with expanded ends), convex-concave (expanded center with pinched ends)
...
• Choose franchises with distinctive settings and visual styles
• Do not reuse the same franchise across renders

Possible franchises and signature settings include: The Flintstones (prehistoric Bedrock, stone houses, foot-powered cars), The Jetsons (futuristic apartment, floating city, conveyor walkways), Yogi Bear (Jellystone Park with picnic tables and ranger elements), Super Friends (Hall of Justice with heroic poses), Wacky Races (exaggerated race vehicles and chaotic motion), Hong Kong Phooey (janitor's closet transforming into hero scene), Josie and the Pussycats (live band performance on stage), Captain Caveman (cave interiors and club-based antics), Johnny Quest (adventure or science-lab environments), Space Ghost (retro space settings or villain confrontations), Fat Albert and the Cosby Kids (urban neighborhood streets, junkyard clubhouses, schoolyards, stoops, or classrooms with warm, grounded slice-of-life tone).
...
Ensure the entire kids’ meal box, toy, and promotional elements are fully visible and readable on a small screen. The final image should feel nostalgic, playful, slightly tacky, and instantly recognizable as a classic kids’ fast-food toy promotion from the 1990s–2000s.`},{name:"HAUNTED EPITAPH",category:["MASTER PROMPT","HORROR","HALLOWEEN","SPOOKY","TEXT"],message:"Take a picture and transform it into a playful, haunted graveyard scene inspired by classic theme-park haunted mansion aesthetics. Depict the subject as a stylized carved portrait, bust, or ghostly cameo associated with a decorative tombstone or memorial plaque, without implying real death. Create a humorous rhyming epitaph in the spirit of whimsical haunted mansion gravestones, using clever wordplay and flavor text inspired by the subject’s appearance, personality, clothing, or surroundings. Ensure the full rhyming epitaph is clearly visible and readable within the image. Use atmospheric lighting, fog, moonlight, and ornate stonework to create a spooky-but-fun tone. Keep the overall mood lighthearted, imaginative, and theatrical rather than dark or morbid.  The result should be a full view of the epitaph with a relevant background behind the epitaph."},{name:"HEADLESS",category:["ILLUSION","MAGIC","SURREAL","THEATRICAL"],message:`Take a picture and create the illusion that the subject is holding their own head — presented clearly as a theatrical magic effect, not an injury.

CORE CONCEPT (CRITICAL):
• This is a classic stage illusion or visual trick
• NO violence, NO injury, NO harm
• The effect must feel playful, clever, and impossible

HEAD ILLUSION RULES (CRITICAL):
• The head being held is a duplicate illusion of the subject’s head
• The held head appears calm, neutral, or mildly amused
• No blood, no wounds, no exposed anatomy

NECK & BODY PRESENTATION (CRITICAL):
• The subject’s body must NOT show any open neck
• The neck area must be fully obscured using:
  – High collar, scarf, cloak, turtleneck, costume, or shadow
• The body must look intact and unharmed

POSE & COMPOSITION:
• The subject holds the head naturally (at waist or chest height)
• The head is oriented upright — not limp or graphic
• The body posture remains relaxed and normal

STYLE & REALISM:
• Photorealistic or cinematic
• Clean illusion edges — no gore artifacts
• Lighting must match between head and body
• The illusion should feel deliberate and staged

TONE:
• Whimsical
• Playful surrealism
• Classic magic-show energy
...
FINAL RESULT:
The final image should look like a clever, theatrical illusion where the subject is calmly holding a perfect illusion of their own head, with their body intact and unharmed — magical, surreal, and visually impressive without any suggestion of violence.`},{name:"HEAD SHOT",category:["HUMOR","PORTRAIT","ACTING"],message:`Take a picture of the subject and turn it into a professional actor’s head shot.
...
• SELECT EXACTLY ONE film using the RANDOM SEED
• Do not reuse the same film across renders
• Options: Night of the Living Dead, Friday the 13th, Nightmare on Elm Street, The Shining, Psycho, Halloween, The Exorcist, Texas Chainsaw Massacre, Scream, The Ring
...
• Choose from well-known historical photographs with clear cultural significance
• Do not reuse the same photograph across renders
...
• Do not reuse the same idiom across renders
• Strongly bias toward variety
• Options: Breaking the ice, Burning the midnight oil, Walking on thin ice, Under pressure, Spilling the beans, Biting off more than you can chew, Sweeping it under the rug, Jumping to conclusions, Holding your horses, Head in the clouds, Letting the cat out of the bag, On the same page, Pulling your leg, Costing an arm and a leg, Hit the nail on the head, Throwing in the towel, Barking up the wrong tree, Piece of cake
...
Preserve recognizable facial features while adding the unfortunate nasal situation.`},{name:"IGOR — MAXIMUM MEL BROOKS",category:["CLASSIC FILM","COMEDY","EXAGGERATED","CHARACTER"],message:`Take a picture and transform the subject into a full comedic homage to Igor from *Young Frankenstein*, embracing exaggerated, over-the-top Mel Brooks–style physical comedy.
...
• SELECT EXACTLY ONE film using the RANDOM SEED
• Do not reuse the same film across renders
• Options: The Breakfast Club, Ferris Bueller's Day Off, Weird Science, Sixteen Candles, Pretty in Pink, Uncle Buck, Home Alone, Planes Trains and Automobiles
...
• SELECT EXACTLY ONE type using the RANDOM SEED
• Do not reuse the same type across renders
• Options: keychain charm, refrigerator magnet
...
SCENARIO SELECTION (CRITICAL):
• SELECT EXACTLY ONE Mandela Effect scenario using the RANDOM SEED
• Do not reuse the same example across renders
• Actively avoid defaulting to the most common or meme-dominant example

PREFERRED VARIETY (NON-EXHAUSTIVE LIST):
...
• Subject holding Kit-Kat chocolate (with incorrect hyphenation)
...
• SELECT EXACTLY ONE show using the RANDOM SEED
• Do not reuse the same show across renders
• Options: MAURY POVICH (paternity test reveals, 'You ARE/ARE NOT the father!' graphics, women running backstage crying, Maury holding DNA results), MORTON DOWNEY JR. (confrontational 80s set, chain-smoking host, audience shouting matches, in-your-face aggressive style), GERALDO (chair-throwing brawls, nose-breaking fights, security rushing in, Geraldo in the middle of chaos), JERRY SPRINGER (chanting audience 'JER-RY! JER-RY!', blonde security guard Steve breaking up fights, chair throwing, love triangles, surprise reveals)
...
• Do not reuse the same musical across renders
• Options: Grease, Footloose, Singin' in the Rain, The Sound of Music, West Side Story, Hairspray, La La Land, The Wizard of Oz, Mary Poppins, Chicago
...
• Do not reuse the same animal across renders
• Options: horse, pig, cow, sheep, goat, chicken, rooster, duck, goose, rabbit
...
• Do not reuse the same location across renders
• Options: chocolate waterfall and river area with candy mushrooms and edible landscape, golden egg room with geese, inventing room with experimental candy machines, television chocolate room with equipment, candy forest with lollipop trees, nut sorting room, fizzy lifting drinks room
...
• Do not reuse the same role across renders
• Options: Gruff narrator (wise, weathered expression, slightly stern or knowing), Villain (exaggerated sneer, arched brows, mischievous or menacing charm, family-friendly), Background elf (cheerful or busy demeanor, simple costume, supporting presence), Skeptical side character (crossed arms, raised eyebrow, doubtful expression), Comic relief (exaggerated smile, clumsy pose, whimsical expression), Hero (determined expression, confident posture, central focus)
...
• SELECT EXACTLY ONE mode using the RANDOM SEED
• Do not reuse the same mode across renders
• Options: Holiday Mode, Year-Round Mode
...
• Do not reuse the same style across renders
• Options: Guy Fawkes-inspired revolutionary mask (white porcelain finish, thin black painted accents, stylized mustache or smile adapted to subject's facial structure), Traditional theatrical mask (Greek comedy or tragedy shaped to subject's face), Venetian carnival mask (ornate decoration built around subject's facial geometry), Horror mask (blank or emotionless but shaped like subject), Japanese Noh mask (wooden painted carved to match subject's proportions), African tribal ceremonial mask (carved wood patterns following subject's facial planes), Mexican Día de los Muertos calavera mask (skull styling mapped to subject's face shape)
...
• SELECT EXACTLY ONE film using the RANDOM SEED
• Do not reuse the same film across renders
• Options: The Princess Bride, When Harry Met Sally, Stand by Me, Misery, This Is Spinal Tap, A Few Good Men, The American President
...
• SELECT EXACTLY ONE Ron Howard film or scene type using the RANDOM SEED
• Choose from his distinctive works with recognizable visual styles
• Do not reuse the same film across renders
...
EPISODE OPTIONS (EXPLICIT — FULL RANGE):
...
• SELECT EXACTLY ONE film using the RANDOM SEED
• Do not reuse the same film across renders
• Options: E.T., Jaws, Saving Private Ryan, Schindler's List, The Goonies, Jurassic Park, Indiana Jones (Raiders of the Lost Ark), Close Encounters of the Third Kind, Hook, Catch Me If You Can
...
JOKE SELECTION (CRITICAL):
• SELECT EXACTLY ONE comedian's style using the RANDOM SEED
• Do not reuse the same comedian across renders
• Options: Stephen Wright, Rodney Dangerfield, Mitch Hedberg, Norm Macdonald, Anthony Jeselnik, Jimmy Carr, Henny Youngman
...
• Do not reuse the same platform across renders
• Options: Netflix, Disney+, Paramount+, HBO Max, Hulu, Amazon Prime Video
...
• Choose from well-known, visually distinctive challenges
• Do not reuse the same challenge across renders

Choose from popular challenges such as: trending dances (Renegade, Savage, WAP dance, Supalonely, Jerk dance, Harlem Shake), Ice Bucket Challenge (bucket of ice water being dumped over head, shocked expression), Milk Crate Challenge (climbing unstable pyramid of stacked crates, mid-fall or wobbling), Silhouette Challenge (striking poses in doorway with red filter effect), Buss It Challenge (transformation from casual to glam outfit mid-drop), Flip the Switch Challenge (outfit swap with another person mid-dance), Don't Rush Challenge (makeup transformation with brush toss), Wipe It Down Challenge (mirror cleaning reveals multiple costume changes), Plank Challenge (planking in unusual locations), Mannequin Challenge (frozen mid-action), Bottle Cap Challenge (roundhouse kicking cap off bottle), In My Feelings Challenge (dancing next to moving car), or other viral challenges.
...
• Do not reuse the same film across renders
• Options: Edward Scissorhands, The Nightmare Before Christmas, Batman, Frankenweenie, Beetlejuice, Big Eyes, Mars Attacks, Corpse Bride, Sleepy Hollow, Charlie and the Chocolate Factory, Sweeney Todd
...
• Do not reuse the same country across renders
...
• Do not reuse the same costume across renders
• Default options: Witch, Vampire, Ghost, Superhero, Monster, Zombie, Pirate, Mummy, Skeleton, Devil
...
The final image must look like a normal photograph of the subject unintentionally striking an over-the-top, ultra-serious fashion model expression — instantly recognizable as a parody of high-fashion posing, confident, intense, and humorously dramatic.`},{name:"ZOO-TOPIA",category:["MOVIES","ANIMAL","ANTHROPOMORPHIC","DISNEY"],message:"Take a picture and transform the subject into a realistic anthropomorphized animal character (Zootopia-style realism). Choose an animal form that naturally fits the subject’s facial structure, body type, and personality. Preserve recognizable facial features, expressions, proportions, hairstyle equivalents (fur patterns), and the subject’s exact clothing translated accurately onto the animal anatomy. The character must stand upright with human-like posture, hands, and gestures while retaining believable animal anatomy, fur detail, and species-specific traits. Photorealistic fur, skin, and fabric interaction with cinematic lighting. The subject must clearly remain the same individual, now reimagined as a believable anthropomorphic animal in a realistic world."}];let m=[...$i],T=0,Se=-1,Q=navigator.onLine,I=[],Ge=!1,Ne=null,Ht=0;const vi=500,ki="r1_camera_queue";let Be,Xe,le;const Ai="r1_camera_styles";let fe=[];const Ri="r1_camera_favorites",Oi="r1_camera_visible_presets";let E=[],Ie=!1,Y=0,pt="",vt=!0;function Aa(e){lt&&(clearTimeout(lt),lt=null),Ke||(Ke=document.getElementById("style-reveal"),ga=document.getElementById("style-reveal-text")),!(!Ke||!ga)&&(ga.textContent=e,Ke.style.display="block",lt=setTimeout(()=>{Ke&&(Ke.style.display="none"),lt=null},1200))}function $t(){return new Promise((e,t)=>{const a=indexedDB.open(Xi,_i);a.onerror=()=>{console.error("Failed to open IndexedDB:",a.error),t(a.error)},a.onsuccess=()=>{$=a.result,console.log("IndexedDB opened successfully"),e($)},a.onupgradeneeded=n=>{$=n.target.result,$.objectStoreNames.contains(Le)||($.createObjectStore(Le,{keyPath:"id"}).createIndex("timestamp","timestamp",{unique:!1}),console.log("Object store created"))}})}async function Qi(){try{const e=localStorage.getItem("r1_gallery_index");if(!e){console.log("No old gallery data to migrate");return}const t=JSON.parse(e);let a=0;for(const n of t){const i="r1_gallery_"+n,s=localStorage.getItem(i);if(s){const o=JSON.parse(s);for(const r of o)await Si(r),a++;localStorage.removeItem(i)}}localStorage.removeItem("r1_gallery_index"),console.log(`Migration complete: ${a} images migrated to IndexedDB`),await Qt()}catch(e){console.error("Migration failed:",e)}}async function Qt(){try{$||await $t(),L=[];const a=$.transaction([Le],"readonly").objectStore(Le).getAll();return new Promise((n,i)=>{a.onsuccess=()=>{L=a.result||[];const s=localStorage.getItem(Ii);s&&(gt=s),L.sort((o,r)=>r.timestamp-o.timestamp),console.log(`Gallery loaded: ${L.length} images`),n()},a.onerror=()=>{console.error("Failed to load gallery:",a.error),L=[],i(a.error)}})}catch(e){console.error("Error loading gallery:",e),L=[]}}async function Si(e){try{$||await $t();const n=$.transaction([Le],"readwrite").objectStore(Le).add(e);return new Promise((i,s)=>{n.onsuccess=()=>{console.log("Image saved to IndexedDB"),i()},n.onerror=()=>{console.error("Failed to save image:",n.error),s(n.error)}})}catch(t){console.error("Error saving image:",t)}}async function Ni(e){try{$||await $t();const n=$.transaction([Le],"readwrite").objectStore(Le).delete(e);return new Promise((i,s)=>{n.onsuccess=()=>{console.log("Image deleted from IndexedDB"),i()},n.onerror=()=>{console.error("Failed to delete image:",n.error),s(n.error)}})}catch(t){console.error("Error deleting image:",t)}}async function Ci(e){const t={id:Date.now().toString()+"-"+Math.random().toString(36).substr(2,9),imageBase64:e,timestamp:Date.now()};L.unshift(t),await Si(t),console.log(`Image added. Total: ${L.length}`)}function Zi(e){return!dt&&!ht?e:e.filter(t=>{const a=new Date(t.timestamp);a.setHours(0,0,0,0);const n=a.getTime();let i=!0,s=!0;if(dt){const o=new Date(dt).getTime();i=n>=o}if(ht){const o=new Date(ht).getTime();s=n<=o}return i&&s})}function es(e){const t=[...e];return gt==="newest"?t.sort((a,n)=>n.timestamp-a.timestamp):t.sort((a,n)=>a.timestamp-n.timestamp),t}function Ra(){let e=Zi(L);return es(e)}async function ne(){xe(),Vi(),R&&R.style.display==="block"&&na(),await Qt();const e=document.getElementById("gallery-modal"),t=document.getElementById("gallery-grid"),a=document.getElementById("gallery-pagination"),n=document.getElementById("page-info"),i=document.getElementById("prev-page"),s=document.getElementById("next-page"),o=document.getElementById("gallery-count");o&&(o.textContent=L.length);const r=document.getElementById("gallery-sort-order");r&&(r.value=gt);const l=Ra();if(l.length===0)t.innerHTML='<div class="gallery-empty">No photos match the selected filter.</div>',a.style.display="none";else{const c=Math.ceil(l.length/Pt);K=Math.min(K,c);const u=(K-1)*Pt,f=Math.min(u+Pt,l.length),v=l.slice(u,f),w=document.createDocumentFragment();v.forEach(O=>{const B=document.createElement("div");if(B.className="gallery-item",Ce&&S.has(O.id)&&B.classList.add("selected"),Ce){const V=document.createElement("input");V.type="checkbox",V.className="gallery-item-checkbox",V.checked=S.has(O.id),V.addEventListener("click",ve=>{ve.stopPropagation(),ai(O.id)}),B.appendChild(V)}const ie=document.createElement("img");ie.src=O.imageBase64,ie.alt="Gallery image",ie.loading="lazy",B.appendChild(ie),B.onclick=()=>{if(Ce)ai(O.id),ne();else{const V=L.findIndex(ve=>ve.id===O.id);is(V)}},w.appendChild(B)}),t.innerHTML="",t.appendChild(w),c>1?(a.style.display="flex",n.textContent=`Page ${K} of ${c}`,i.disabled=K===1,s.disabled=K===c):a.style.display="none"}e.style.display="flex"}async function ts(){document.getElementById("gallery-modal").style.display="none",K=1,await Wi()}function as(){const e=Ra(),t=Math.ceil(e.length/Pt);K<t&&(K++,ne())}function ns(){K>1&&(K--,ne())}function pa(){K=1,ne()}function ti(e,t){const a=e==="start"?"gallery-start-date-btn":"gallery-end-date-btn",n=document.getElementById(a);if(!n)return;const i=n.querySelector(".date-button-text");if(i)if(t){const o=new Date(t+"T00:00:00").toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"});i.textContent=o,n.classList.add("has-date")}else i.textContent=e==="start"?"Start":"End",n.classList.remove("has-date")}function is(e){if(e<0||e>=L.length)return;J=e;const t=L[e],a=document.getElementById("image-viewer"),n=document.getElementById("viewer-image"),i=document.getElementById("viewer-prompt");n.src=t.imageBase64,n.style.transform="scale(1) translate(0, 0)",oe=1,i.value="",a.style.display="flex",document.getElementById("gallery-modal").style.display="none"}function ss(){document.getElementById("image-viewer").style.display="none",J=-1,oe=1;const e=document.getElementById("gallery-modal");e.style.display="flex",ne()}async function os(){if(!(J<0||J>=L.length)&&confirm("Delete this image from gallery?")){const e=L[J];await Ni(e.id),L.splice(J,1),document.getElementById("image-viewer").style.display="none",J=-1,oe=1,ne()}}function rs(){const e=document.getElementById("preset-selector");kt();const t=document.getElementById("preset-count");t&&(t.textContent=m.length),e.style.display="flex",he=!0,x=0,Ve(),setTimeout(()=>{const a=document.getElementById("preset-list");a&&ba>0&&(a.scrollTop=ba)},50)}function Ft(){const e=document.getElementById("preset-list");e&&(ba=e.scrollTop),document.getElementById("preset-selector").style.display="none",Bt="",Fe="",document.getElementById("preset-filter").value="",he=!1,x=0;const t=document.getElementById("preset-selector-category-hint");t&&(t.style.display="none"),_t=!1}function ls(){if(!he)return;const e=document.getElementById("preset-list");!e||e.querySelectorAll(".preset-item").length===0||(x=Math.max(0,x-1),Ve())}function cs(){if(!he)return;const e=document.getElementById("preset-list");if(!e)return;const t=e.querySelectorAll(".preset-item");t.length!==0&&(x=Math.min(t.length-1,x+1),Ve())}function Ve(){const e=document.getElementById("preset-list");if(!e)return;const t=e.querySelectorAll(".preset-item");if(t.length!==0&&(t.forEach(a=>{a.classList.remove("preset-selected")}),x>=0&&x<t.length)){const a=t[x];a.classList.add("preset-selected"),a.scrollIntoView({behavior:"smooth",block:"nearest"});const n=a.querySelector(".preset-name").textContent,i=m.find(o=>o.name===n),s=document.getElementById("preset-selector-category-hint");s&&i&&i.category?(s.innerHTML="",s.style.display="block",i.category.forEach((o,r)=>{const l=document.createElement("span");if(l.textContent=o,l.style.cursor="pointer",l.style.padding="0 2px",Fe===o&&(l.style.textDecoration="underline",l.style.fontWeight="bold"),l.onclick=c=>{c.stopPropagation(),Fe===o?Fe="":Fe=o,x=0,kt()},s.appendChild(l),r<i.category.length-1){const c=document.createElement("span");c.textContent=", ",s.appendChild(c)}})):s&&(s.style.display="none")}}function ds(){if(!D)return;const e=document.getElementById("settings-submenu");!e||e.querySelectorAll(".menu-section-button").length===0||(ee=Math.max(0,ee-1),Oa())}function hs(){if(!D)return;const e=document.getElementById("settings-submenu");if(!e)return;const t=e.querySelectorAll(".menu-section-button");t.length!==0&&(ee=Math.min(t.length-1,ee+1),Oa())}function Oa(){const e=document.getElementById("settings-submenu");if(!e)return;const t=e.querySelectorAll(".menu-section-button");if(t.length!==0&&(t.forEach(a=>{a.classList.remove("menu-selected")}),ee>=0&&ee<t.length)){const a=t[ee];a.classList.add("menu-selected"),a.scrollIntoView({behavior:"smooth",block:"nearest"})}}function us(){const e=document.getElementById("resolution-submenu");if(!e||e.style.display!=="flex")return;const t=e.querySelectorAll(".resolution-item");t.length!==0&&(te=(te-1+t.length)%t.length,Sa(t))}function ms(){const e=document.getElementById("resolution-submenu");if(!e||e.style.display!=="flex")return;const t=e.querySelectorAll(".resolution-item");t.length!==0&&(te=(te+1)%t.length,Sa(t))}function Sa(e){if(e.forEach(t=>t.classList.remove("menu-selected")),te>=0&&te<e.length){const t=e[te];t.classList.add("menu-selected"),t.scrollIntoView({behavior:"smooth",block:"nearest"})}}function gs(){const e=document.getElementById("burst-submenu");if(!e||e.style.display!=="flex")return;const t=e.querySelector(".submenu-list");t&&(t.scrollTop=Math.max(0,t.scrollTop-80))}function ps(){const e=document.getElementById("burst-submenu");if(!e||e.style.display!=="flex")return;const t=e.querySelector(".submenu-list");t&&(t.scrollTop=Math.min(t.scrollHeight-t.clientHeight,t.scrollTop+80))}function fs(){const e=document.getElementById("timer-settings-submenu");if(!e||e.style.display!=="flex")return;const t=e.querySelector(".submenu-list");t&&(t.scrollTop=Math.max(0,t.scrollTop-80))}function ys(){const e=document.getElementById("timer-settings-submenu");if(!e||e.style.display!=="flex")return;const t=e.querySelector(".submenu-list");t&&(t.scrollTop=Math.min(t.scrollHeight-t.clientHeight,t.scrollTop+80))}function bs(){const e=document.getElementById("master-prompt-submenu");if(!e||e.style.display!=="flex")return;const t=e.querySelector(".submenu-list");t&&(t.scrollTop=Math.max(0,t.scrollTop-80))}function Ts(){const e=document.getElementById("master-prompt-submenu");if(!e||e.style.display!=="flex")return;const t=e.querySelector(".submenu-list");t&&(t.scrollTop=Math.min(t.scrollHeight-t.clientHeight,t.scrollTop+80))}function Es(){const e=document.getElementById("motion-submenu");if(!e||e.style.display!=="flex")return;const t=e.querySelector(".submenu-list");t&&(t.scrollTop=Math.max(0,t.scrollTop-80))}function ws(){const e=document.getElementById("motion-submenu");if(!e||e.style.display!=="flex")return;const t=e.querySelector(".submenu-list");t&&(t.scrollTop=Math.min(t.scrollHeight-t.clientHeight,t.scrollTop+80))}function Li(){if(!nt)return;const e=document.getElementById("preset-builder-submenu");if(!e||e.style.display!=="flex")return;const t=e.querySelector(".preset-builder-form");t&&(t.scrollTop=Math.max(0,t.scrollTop-80))}function Mi(){if(!nt)return;const e=document.getElementById("preset-builder-submenu");if(!e||e.style.display!=="flex")return;const t=e.querySelector(".preset-builder-form");t&&(t.scrollTop=Math.min(t.scrollHeight-t.clientHeight,t.scrollTop+80))}function Is(){const e=document.getElementById("gallery-modal");if(!e||e.style.display!=="flex")return;const t=e.querySelector(".gallery-scroll-container");t&&(t.scrollTop=Math.max(0,t.scrollTop-80))}function vs(){const e=document.getElementById("gallery-modal");if(!e||e.style.display!=="flex")return;const t=e.querySelector(".gallery-scroll-container");t&&(t.scrollTop=Math.min(t.scrollHeight-t.clientHeight,t.scrollTop+80))}function ks(){const e=document.getElementById("image-viewer");if(!e||e.style.display!=="flex")return;const t=e.querySelector(".viewer-controls");t&&(t.scrollTop=Math.max(0,t.scrollTop-80))}function As(){const e=document.getElementById("image-viewer");if(!e||e.style.display!=="flex")return;const t=e.querySelector(".viewer-controls");t&&(t.scrollTop=Math.min(t.scrollHeight-t.clientHeight,t.scrollTop+80))}function Rs(){const e=document.getElementById("style-editor");if(!e||e.style.display!=="flex")return;const t=e.querySelector(".style-editor-body");t&&(t.scrollTop=Math.max(0,t.scrollTop-80))}function Os(){const e=document.getElementById("style-editor");if(!e||e.style.display!=="flex")return;const t=e.querySelector(".style-editor-body");t&&(t.scrollTop=Math.min(t.scrollHeight-t.clientHeight,t.scrollTop+80))}function Ss(){const e=document.getElementById("queue-manager");if(!e||e.style.display!=="flex")return;const t=e.querySelector(".queue-list");t&&(t.scrollTop=Math.max(0,t.scrollTop-80))}function Ns(){const e=document.getElementById("queue-manager");if(!e||e.style.display!=="flex")return;const t=e.querySelector(".queue-list");t&&(t.scrollTop=Math.min(t.scrollHeight-t.clientHeight,t.scrollTop+80))}function Cs(){if(!he)return;const e=document.getElementById("preset-list");if(!e)return;const t=e.querySelectorAll(".preset-item");if(t.length===0||x>=t.length)return;const a=t[x];a&&a.click()}function kt(){const e=document.getElementById("preset-list");e.innerHTML="";const a=Ws().filter(r=>{if(Bt){const l=Bt.toLowerCase(),c=r.category&&r.category.some(f=>f.toLowerCase().includes(l));if(!(r.name.toLowerCase().includes(l)||r.message.toLowerCase().includes(l)||c))return!1}return Fe?r.category&&r.category.includes(Fe):!0}).sort((r,l)=>r.name.localeCompare(l.name)),n=a.filter(r=>at(r.name)),i=a.filter(r=>!at(r.name)),s=[...n,...i];if(s.length===0){e.innerHTML='<div class="preset-empty">No presets found</div>';return}s.forEach(r=>{const l=document.createElement("div");l.className="preset-item";const c=document.createElement("div");c.className="preset-name",c.textContent=r.name;const u=document.createElement("div");u.className="preset-description preset-description-hidden",u.textContent=r.message,l.appendChild(c),l.appendChild(u),l.onclick=()=>{u.classList.contains("preset-description-hidden")?u.classList.remove("preset-description-hidden"):Ls(r)},e.appendChild(l)});const o=document.getElementById("preset-count");o&&(o.textContent=s.length)}async function Ls(e){if(_t){const a=Te.findIndex(n=>n.name===e.name);a>-1?Te.splice(a,1):Te.push(e),ji();return}if(window.batchProcessingActive){window.batchProcessingActive=!1;const a=window.batchImagesToProcess;window.batchImagesToProcess=null,Ft();const i=document.getElementById("preset-selector").querySelector(".preset-selector-header h3");i.textContent="Select Preset",await Ds(e,a);return}const t=document.getElementById("viewer-prompt");t.value=e.message,Ft()}function Ms(){if(J<0||J>=L.length){alert("No image selected");return}const t=document.getElementById("viewer-prompt").value.trim();if(!t){alert("Please enter a prompt or load a preset");return}const a=L[J];typeof PluginMessageHandler<"u"?(PluginMessageHandler.postMessage(JSON.stringify({message:sa(t),pluginId:"com.r1.pixelart",imageBase64:a.imageBase64})),alert("Magic transform submitted! You can submit again with a different prompt.")):alert("Magic transform sent: "+t.substring(0,50)+"...")}function Gt(){Ce=!Ce;const e=document.getElementById("batch-mode-toggle"),t=document.getElementById("batch-controls"),a=document.getElementById("batch-action-bar");Ce?(e.textContent="Done",e.classList.add("active"),t.style.display="flex",a.style.display="flex",S.clear(),Zt(),ne()):(e.textContent="Select",e.classList.remove("active"),t.style.display="none",a.style.display="none",S.clear(),ne())}function Zt(){const e=document.getElementById("batch-selected-count"),t=document.getElementById("batch-apply-preset"),a=document.getElementById("batch-delete");e.textContent=`${S.size} selected`,t.disabled=S.size===0,a&&(a.disabled=S.size===0)}function js(){const e=Ra();S.clear(),e.forEach(t=>S.add(t.id)),Zt(),ne()}function xs(){S.clear(),Zt(),ne()}function ai(e){S.has(e)?S.delete(e):S.add(e),Zt()}async function Ps(){if(S.size===0)return;const e=document.getElementById("preset-selector"),t=e.querySelector(".preset-selector-header h3");t.textContent=`Select Preset (${S.size} images)`;const a=Array.from(S);window.batchProcessingActive=!0,window.batchImagesToProcess=a,kt(),e.style.display="flex",he=!0,x=0,Ve()}async function Ds(e,t){const a=t||Array.from(S),n=a.length,i=document.createElement("div");i.className="batch-progress-overlay",i.innerHTML=`
  ...
  `,document.body.appendChild(i);let s=0;for(const o of a){const r=L.find(l=>l.id===o);if(r)try{const l=sa(e.message);typeof PluginMessageHandler<"u"&&PluginMessageHandler.postMessage(JSON.stringify({message:l,pluginId:"com.r1.pixelart",imageBase64:r.imageBase64})),s++,document.getElementById("batch-current").textContent=s,document.getElementById("batch-progress-fill").style.width=`${s/n*100}%`,await new Promise(c=>setTimeout(c,2e3))}catch(l){console.error(`Failed to process image ${o}:`,l)}}document.body.removeChild(i),Ce=!1,S.clear(),Gt(),alert(`Batch processing complete! ${s} of ${n} images submitted.`)}async function Us(){if(S.size===0)return;const e=S.size;if(!confirm(`Are you sure you want to delete ${e} selected image${e>1?"s":""}? This cannot be undone.`))return;const a=Array.from(S),n=document.createElement("div");n.className="batch-progress-overlay",n.innerHTML=`
    <div class="batch-progress-text">Deleting <span id="batch-current">0</span> / ${e}</div>
    <div class="batch-progress-bar">
      <div class="batch-progress-fill" id="batch-progress-fill" style="width: 0%"></div>
    </div>
  `,document.body.appendChild(n);let i=0;for(const s of a)try{await Ni(s),i++,document.getElementById("batch-current").textContent=i,document.getElementById("batch-progress-fill").style.width=`${i/e*100}%`}catch(o){console.error(`Failed to delete image ${s}:`,o)}document.body.removeChild(n),Ce=!1,S.clear(),await Qt(),Gt(),alert(`${i} of ${e} image${i>1?"s":""} deleted successfully.`)}function Bs(e){Ut=e,Te=[],_t=!0;const t=document.getElementById("preset-selector"),a=t.querySelector(".preset-selector-header h3");a.innerHTML='Select Presets (Multi-Select) <span id="multi-preset-count" style="font-size: 12px; color: #666;">(0 selected)</span>';let n=document.getElementById("multi-preset-controls");if(!n){n=document.createElement("div"),n.id="multi-preset-controls",n.style.cssText="padding: 8px; background: #f5f5f5; border-bottom: 1px solid #ddd; display: flex; gap: 8px; justify-content: space-between;",n.innerHTML=`
    ...
    `;const i=document.getElementById("preset-filter");i.parentNode.insertBefore(n,i.nextSibling)}n.style.display="flex",kt(),ji(),t.style.display="flex",he=!0,x=0,Ve(),document.getElementById("multi-preset-apply").onclick=Hs,document.getElementById("multi-preset-cancel").onclick=xi}function ji(){document.getElementById("preset-list").querySelectorAll(".preset-item").forEach(n=>{const i=n.querySelector(".preset-name").textContent;Te.some(o=>o.name===i)?(n.style.background="#e8f5e9",n.style.border="2px solid #4CAF50"):(n.style.background="",n.style.border="")});const a=document.getElementById("multi-preset-count");a&&(a.textContent=`(${Te.length} selected)`)}function xi(){_t=!1,Ut=null,Te=[];const e=document.getElementById("multi-preset-controls");e&&(e.style.display="none");const t=document.querySelector(".preset-selector-header h3");t.textContent="Select Preset",Ft()}async function Hs(){if(Te.length===0){alert("Please select at least one preset");return}if(!Ut){alert("No image selected");return}const e=L.find(i=>i.id===Ut);if(!e){alert("Image not found");return}const t=[...Te];xi();const a=document.createElement("div");a.className="batch-progress-overlay",a.innerHTML=`
    <div class="batch-progress-text">Applying preset <span id="batch-current">0</span> / ${t.length}</div>
    <div class="batch-progress-bar">
      <div class="batch-progress-fill" id="batch-progress-fill" style="width: 0%"></div>
    </div>
  `,document.body.appendChild(a);let n=0;for(const i of t)try{const s=sa(i.message);typeof PluginMessageHandler<"u"&&PluginMessageHandler.postMessage(JSON.stringify({message:s,pluginId:"com.r1.pixelart",imageBase64:e.imageBase64})),n++,document.getElementById("batch-current").textContent=n,document.getElementById("batch-progress-fill").style.width=`${n/t.length*100}%`,await new Promise(o=>setTimeout(o,2e3))}catch(s){console.error(`Failed to apply preset ${i.name}:`,s)}document.body.removeChild(a),alert(`${n} preset${n>1?"s":""} applied successfully!`)}function Fs(){const e=document.getElementById("viewer-image"),t=document.querySelector(".image-viewer-container");let a=0,n=0,i=0,s=0,o=!1;t.addEventListener("touchstart",r=>{r.touches.length===2?(r.preventDefault(),Lt=!0,Qn=ni(r.touches[0],r.touches[1]),Zn=oe):r.touches.length===1&&oe>1&&(o=!0,i=r.touches[0].clientX-a,s=r.touches[0].clientY-n)},{passive:!1}),t.addEventListener("touchmove",r=>{if(Lt&&r.touches.length===2){r.preventDefault();const c=ni(r.touches[0],r.touches[1])/Qn;oe=Math.max(1,Math.min(Zn*c,5)),e.style.transform=`scale(${oe}) translate(${a}px, ${n}px)`}else o&&r.touches.length===1&&oe>1&&(r.preventDefault(),a=r.touches[0].clientX-i,n=r.touches[0].clientY-s,e.style.transform=`scale(${oe}) translate(${a}px, ${n}px)`)},{passive:!1}),t.addEventListener("touchend",r=>{r.touches.length<2&&(Lt=!1),r.touches.length===0&&(o=!1,oe===1&&(a=0,n=0,e.style.transform="scale(1) translate(0, 0)"))}),t.addEventListener("touchcancel",()=>{Lt=!1,o=!1})}function ni(e,t){const a=e.clientX-t.clientX,n=e.clientY-t.clientY;return Math.sqrt(a*a+n*n)}function it(){if(!N)return;const e=document.getElementById("menu-styles-list");if(!e)return;const t=e.querySelectorAll(".style-item");if(t.length===0)return;t.forEach(n=>{n.classList.remove("menu-selected")}),U=Math.max(0,Math.min(U,t.length-1));const a=t[U];if(a){a.classList.add("menu-selected"),a.scrollIntoView({behavior:"smooth",block:"nearest"});const n=parseInt(a.dataset.index),i=m[n],s=document.getElementById("menu-category-hint");s&&i&&i.category?(s.innerHTML="",s.style.display="block",i.category.forEach((o,r)=>{const l=document.createElement("span");if(l.textContent=o,l.style.cursor="pointer",l.style.padding="0 2px",pe===o&&(l.style.textDecoration="underline",l.style.fontWeight="bold"),l.onclick=c=>{c.stopPropagation(),pe===o?pe="":pe=o,U=0,Ee()},s.appendChild(l),r<i.category.length-1){const c=document.createElement("span");c.textContent=", ",s.appendChild(c)}})):s&&(s.style.display="none")}}function Gs(){if(!N||!je)return;const e=document.getElementById("menu-styles-list");!e||e.querySelectorAll(".style-item").length===0||(U=Math.max(0,U-1),it())}function Ys(){if(!N||!je)return;const e=document.getElementById("menu-styles-list");if(!e)return;const t=e.querySelectorAll(".style-item");t.length!==0&&(U=Math.min(t.length-1,U+1),it())}function zs(){if(!N||!je)return;const e=document.getElementById("menu-styles-list");if(!e)return;const t=e.querySelectorAll(".style-item");if(t.length===0||U>=t.length)return;const a=t[U];if(a&&a.querySelector(".style-name")){const s=Rt()[U];if(s){const o=m.findIndex(r=>r===s);o!==-1&&(T=o,z(),ja())}}}function Vs(){const e=localStorage.getItem(Ai);if(e)try{const i=JSON.parse(e).filter(s=>s.internal===!1);m.push(...i)}catch(n){console.error("Error loading styles:",n)}const t=localStorage.getItem(Ri);if(t)try{fe=JSON.parse(t),Array.isArray(fe)||(fe=[])}catch(n){console.error("Error parsing favorite styles:",n),fe=[]}Qs(),_s(),Ks();const a=localStorage.getItem(Oi);if(a)try{E=JSON.parse(a),Array.isArray(E)||(E=[])}catch(n){console.error("Error parsing visible presets:",n),E=[]}E.length===0&&(E=m.map(n=>n.name),Me())}function Me(){try{localStorage.setItem(Oi,JSON.stringify(E))}catch(e){console.error("Error saving visible presets:",e)}}function Ws(){return m.filter(e=>E.includes(e.name))}function qs(e){try{localStorage.setItem(di,e.toString())}catch(t){console.error("Error saving resolution:",t)}}function Ks(){const e=localStorage.getItem(hi);e!==null&&($e=parseInt(e))}function Js(){localStorage.setItem(hi,$e.toString())}function At(){h&&setTimeout(()=>{const e=va[$e];switch(h.style.filter="",e.value){case"daylight":h.style.filter="brightness(1.05) saturate(1.1)";break;case"cloudy":h.style.filter="brightness(1.1) saturate(0.95) sepia(0.05)";break;case"tungsten":h.style.filter="brightness(0.95) saturate(1.15) hue-rotate(-10deg)";break;case"fluorescent":h.style.filter="brightness(1.02) saturate(1.05) hue-rotate(5deg)";break;case"candlelight":h.style.filter="brightness(0.85) saturate(1.3) sepia(0.15) hue-rotate(-15deg)";break;case"moonlight":h.style.filter="brightness(0.7) saturate(0.8) hue-rotate(15deg) contrast(1.1)";break;case"auto":default:h.style.filter="";break}},50)}function Pi(e,t,a){const n=va[$e];if(n.value==="auto")return;const i=e.getImageData(0,0,t,a),s=i.data;let o=1,r=1,l=0,c=1;switch(n.value){case"daylight":o=1.05,r=1.1,l=5;break;case"cloudy":o=1.1,r=.95,l=10;break;case"tungsten":o=.95,r=1.15,l=-20;break;case"fluorescent":o=1.02,r=1.05,l=-10;break;case"candlelight":o=.85,r=1.3,l=25,c=.95;break;case"moonlight":o=.7,r=.8,l=-15,c=1.1;break}for(let u=0;u<s.length;u+=4){let f=s[u],v=s[u+1],w=s[u+2];l>0?(f=Math.min(255,f+l),v=Math.min(255,v+l*.5)):l<0&&(w=Math.min(255,w-l)),f*=o,v*=o,w*=o;const O=.2989*f+.587*v+.114*w;f=O+r*(f-O),v=O+r*(v-O),w=O+r*(w-O),f=((f/255-.5)*c+.5)*255,v=((v/255-.5)*c+.5)*255,w=((w/255-.5)*c+.5)*255,s[u]=Math.max(0,Math.min(255,f)),s[u+1]=Math.max(0,Math.min(255,v)),s[u+2]=Math.max(0,Math.min(255,w))}e.putImageData(i,0,0)}function Xs(){document.getElementById("settings-submenu").style.display="none";const e=document.getElementById("white-balance-submenu"),t=document.getElementById("white-balance-list");t.innerHTML="",va.forEach((a,n)=>{const i=document.createElement("div");i.className="resolution-item",n===$e&&i.classList.add("active");const s=document.createElement("span");s.className="resolution-name",s.textContent=a.name,i.appendChild(s),i.onclick=()=>{$e=n,Js(),document.getElementById("current-white-balance-display").textContent=a.name,k&&At(),Di()},t.appendChild(i)}),e.style.display="flex"}function Di(){document.getElementById("white-balance-submenu").style.display="none",document.getElementById("settings-submenu").style.display="flex"}function _s(){try{const e=localStorage.getItem(di);if(e!==null){const t=parseInt(e,10);t>=0&&t<Et.length&&(ye=t)}}catch(e){console.error("Error loading resolution:",e)}}function ft(){const t=m.filter(i=>E.includes(i.name)).slice().sort((i,s)=>i.name.localeCompare(s.name)),a=t.filter(i=>at(i.name)),n=t.filter(i=>!at(i.name));return{favorites:a,regular:n}}function Rt(){const{favorites:e,regular:t}=ft(),a=e.filter(i=>E.includes(i.name)),n=t.filter(i=>E.includes(i.name));return[...a,...n]}function Ui(){const e=Rt(),t=m[T];return e.findIndex(a=>a===t)}function Bi(e){const a=Rt()[e];return m.findIndex(n=>n===a)}function ea(){try{const e=m.filter(t=>t.internal===!1);localStorage.setItem(Ai,JSON.stringify(e))}catch(e){console.error("Error saving styles:",e)}}function $s(e){const t=fe.indexOf(e);t>-1?fe.splice(t,1):fe.push(e),localStorage.setItem(Ri,JSON.stringify(fe));const a=document.querySelector(".styles-menu-scroll-container"),n=a?a.scrollTop:0;Ee(),a&&(a.scrollTop=n)}function Qs(){const e=localStorage.getItem(gi);if(e!==null)try{const t=parseInt(e,10);t>=0&&t<m.length&&(T=t)}catch(t){console.error("Error loading last used style:",t)}}function at(e){return fe.includes(e)}function Hi(){const e=m.filter(n=>!n.internal&&at(n.name));if(e.length>0){const n=e[Math.floor(Math.random()*e.length)];return m.findIndex(i=>i===n)}const t=m.filter(n=>!n.internal);if(t.length===0)return 0;const a=t[Math.floor(Math.random()*t.length)];return m.findIndex(n=>n===a)}function Zs(){ce=!ce;const e=document.getElementById("motion-toggle");if(ce)e.classList.add("active"),e.title="Motion Detection: ON",showStatus("Motion Detection enabled - Press side button to start",3e3);else{e.classList.remove("active"),e.title="Motion Detection: OFF",La(),ct&&(clearInterval(ct),ct=null);const t=document.getElementById("timer-countdown");t&&(t.style.display="none",t.classList.remove("countdown-fade-in","countdown-fade-out"));const a=document.getElementById("camera-button");a&&A.length>1&&(a.style.display="flex"),showStatus("Motion Detection OFF",2e3)}}function eo(){for(let e in mt)if(mt[e].seconds===tt)return parseInt(e);return 1}function to(){document.getElementById("settings-submenu").style.display="none",document.getElementById("motion-submenu").style.display="flex",Xt=!0,D=!1}function ao(){document.getElementById("motion-submenu").style.display="none",Xt=!1,ue()}function no(){document.getElementById("settings-submenu").style.display="none",document.getElementById("visible-presets-submenu").style.display="flex",N=!1,Ie=!0,vt=!0,D=!1,Y=0,pt="",document.getElementById("visible-presets-filter").value="",_e(),Yt()}function io(){document.getElementById("visible-presets-submenu").style.display="none",Ie=!1,vt=!1,Y=0,pt="",He="";const e=document.getElementById("visible-presets-category-hint");e&&(e.style.display="none"),ue()}function Fi(){document.getElementById("settings-submenu").style.display="none",document.getElementById("preset-builder-submenu").style.display="flex",N=!1,D=!1,nt=!0,ta()}function Na(){document.getElementById("preset-builder-submenu").style.display="none",nt=!1,re=-1;const e=document.getElementById("preset-builder-delete");e&&(e.style.display="none"),ue()}function ta(){re=-1,document.getElementById("preset-builder-name").value="",document.getElementById("preset-builder-category").value="",document.getElementById("preset-builder-template").value="",document.getElementById("preset-builder-prompt").value="";const e=document.getElementById("preset-builder-delete");e&&(e.style.display="none");const t=document.getElementById("preset-builder-clear");t&&(t.style.display="flex")}function so(e){const t=m[e];Fi(),re=e,setTimeout(()=>{const a=document.getElementById("preset-builder-name"),n=document.getElementById("preset-builder-category"),i=document.getElementById("preset-builder-prompt"),s=document.getElementById("preset-builder-template"),o=document.getElementById("preset-builder-delete"),r=document.getElementById("preset-builder-clear");a&&(a.value=t.name),n&&(n.value=t.category?t.category.join(", "):""),i&&(i.value=t.message),s&&(s.value=""),o&&(o.style.display="flex"),r&&(r.style.display="none")},100)}function oo(){const e=document.getElementById("preset-builder-template"),t=document.getElementById("preset-builder-prompt"),a=e.value;a&&ei[a]!==void 0&&(t.value=ei[a])}function ro(){const e=new Set;return m.forEach(t=>{t.category&&Array.isArray(t.category)&&t.category.forEach(a=>{e.add(a.toUpperCase())})}),Array.from(e).sort()}function lo(){const e=document.getElementById("preset-builder-name").value.trim(),t=document.getElementById("preset-builder-category").value.trim(),a=document.getElementById("preset-builder-prompt").value.trim();if(!e){alert("Please enter a preset name");return}if(!a){alert("Please enter a prompt");return}const n=t?t.split(",").map(i=>i.trim().toUpperCase()).filter(i=>i.length>0):["CUSTOM"];if(re>=0){const i=m[re].name;if(m[re]={name:e.toUpperCase(),category:n,message:a,internal:!1},i!==e.toUpperCase()){const s=E.indexOf(i);s>-1&&(E[s]=e.toUpperCase())}}else{const i=m.findIndex(o=>o.name.toUpperCase()===e.toUpperCase());if(i!==-1){if(!confirm(`A preset named "${e}" already exists. Do you want to overwrite it?`))return;m.splice(i,1)}const s={name:e.toUpperCase(),category:n,message:a,internal:!1};m.push(s),E.includes(s.name)||E.push(s.name)}Me(),ea(),alert(re>=0?`Preset "${e}" updated!`:`Preset "${e}" saved successfully!`),ta(),Na(),N&&Ee()}function co(){if(re<0){alert("No preset selected for deletion");return}const e=m[re];if(e.internal!==!1){alert("Cannot delete built-in presets");return}if(!confirm(`Delete preset "${e.name}"? This cannot be undone.`))return;m.splice(re,1);const t=E.indexOf(e.name);t>-1&&(E.splice(t,1),Me()),T>=m.length&&(T=m.length-1),ea(),alert(`Preset "${e.name}" deleted successfully!`),ta(),Na(),N&&Ee()}function _e(){const e=document.getElementById("visible-presets-list");e.innerHTML="";const n=m.filter(o=>!o.internal).filter(o=>{if(pt){const r=pt.toLowerCase(),l=o.category&&o.category.some(u=>u.toLowerCase().includes(r));if(!(o.name.toLowerCase().includes(r)||l))return!1}return He?o.category&&o.category.includes(He):!0}).sort((o,r)=>o.name.localeCompare(r.name)),i=document.createDocumentFragment();n.forEach(o=>{const r=document.createElement("div");r.className="style-item",r.dataset.presetName=o.name;const l=document.createElement("input");l.type="checkbox",l.className="master-prompt-checkbox",l.checked=E.includes(o.name),l.style.marginRight="3vw";const c=document.createElement("span");c.className="style-name",c.textContent=o.name,r.appendChild(l),r.appendChild(c),l.onclick=u=>{u.stopPropagation(),ii(o.name,l.checked)},r.onclick=()=>{l.checked=!l.checked,ii(o.name,l.checked)},i.appendChild(r)}),e.appendChild(i);const s=document.getElementById("visible-presets-count");if(s){const o=n.filter(r=>E.includes(r.name)).length;s.textContent=o}setTimeout(()=>{yt()},50)}function ii(e,t){const a=E.indexOf(e);t&&a===-1?E.push(e):!t&&a>-1&&E.splice(a,1),Me(),Yt(),_e();const n=document.getElementById("styles-count");if(n){const{favorites:i,regular:s}=ft(),o=i.length+s.length;n.textContent=o}N&&Ee()}function Yt(){const e=document.getElementById("current-visible-presets-display");if(e){const t=m.filter(n=>!n.internal).length,a=E.length;e.textContent=a===t?"All Visible":`${a} of ${t}`}}function ho(){if(!Ie||!vt)return;const e=document.getElementById("visible-presets-list");!e||e.querySelectorAll(".style-item").length===0||(Y=Math.max(0,Y-1),yt())}function uo(){if(!Ie||!vt)return;const e=document.getElementById("visible-presets-list");if(!e)return;const t=e.querySelectorAll(".style-item");t.length!==0&&(Y=Math.min(t.length-1,Y+1),yt())}function yt(){if(!Ie)return;const e=document.getElementById("visible-presets-list");if(!e)return;const t=e.querySelectorAll(".style-item");if(t.length===0)return;t.forEach(n=>{n.classList.remove("menu-selected")}),Y=Math.max(0,Math.min(Y,t.length-1));const a=t[Y];if(a){a.classList.add("menu-selected"),a.scrollIntoView({behavior:"smooth",block:"nearest"});const n=a.dataset.presetName,i=m.find(o=>o.name===n),s=document.getElementById("visible-presets-category-hint");s&&i&&i.category?(s.innerHTML="",s.style.display="block",i.category.forEach((o,r)=>{const l=document.createElement("span");if(l.textContent=o,l.style.cursor="pointer",l.style.padding="0 2px",He===o&&(l.style.textDecoration="underline",l.style.fontWeight="bold"),l.onclick=c=>{c.stopPropagation(),He===o?He="":He=o,Y=0,_e()},s.appendChild(l),r<i.category.length-1){const c=document.createElement("span");c.textContent=", ",s.appendChild(c)}})):s&&(s.style.display="none")}}function mo(){if(!Ie||!vt)return;const e=document.getElementById("visible-presets-list");if(!e)return;const t=e.querySelectorAll(".style-item");if(t.length===0||Y>=t.length)return;const a=t[Y];a&&a.click()}function Gi(){const e=["Very Low","Low","Medium","High","Very High"],t=document.getElementById("current-motion-display");if(t){const a=Math.floor((50-Ze)/10)+1,n=Math.max(1,Math.min(5,a));t.textContent=`Sensitivity: ${e[n-1]}`}}function Mt(){const e={motionThreshold:Ze,motionPixelThreshold:ka,motionContinuousEnabled:ze,motionCooldown:et,motionStartDelay:tt};try{localStorage.setItem(Ei,JSON.stringify(e))}catch(t){console.error("Failed to save motion settings:",t)}}function go(){try{const e=localStorage.getItem(Ei);if(e){const o=JSON.parse(e);Ze=o.motionThreshold||30,ka=o.motionPixelThreshold||.1,ze=o.motionContinuousEnabled!==void 0?o.motionContinuousEnabled:!0,et=o.motionCooldown||2,tt=o.motionStartDelay||3}const t=document.getElementById("motion-sensitivity-slider");if(t){const o=Math.floor((50-Ze)/10)+1;t.value=Math.max(1,Math.min(5,o))}const a=document.getElementById("motion-continuous-enabled");a&&(a.checked=ze);const n=document.getElementById("motion-cooldown-slider");n&&(n.value=et);const i=document.getElementById("motion-start-delay-slider"),s=document.getElementById("motion-start-delay-value");if(i&&s){const o=eo();i.value=o,s.textContent=mt[o].label}Gi()}catch(e){console.error("Failed to load motion settings:",e)}}function po(){H=!H;const e=document.getElementById("no-magic-status");e&&(e.textContent=H?"Enabled":"Disabled",e.style.color=H?"#4CAF50":"",e.style.fontWeight=H?"600":"");try{localStorage.setItem(wi,JSON.stringify(H))}catch(t){console.error("Failed to save No Magic mode:",t)}H?showStatus("No Magic Mode ON - Camera only",2e3):showStatus("No Magic Mode OFF - AI prompts enabled",2e3)}function fo(){try{const e=localStorage.getItem(wi);if(e!==null){H=JSON.parse(e);const t=document.getElementById("no-magic-status");t&&(t.textContent=H?"Enabled":"Disabled",t.style.color=H?"#4CAF50":"",t.style.fontWeight=H?"600":"")}}catch(e){console.error("Failed to load No Magic mode:",e)}}function yo(){document.getElementById("settings-submenu").style.display="none",document.getElementById("tutorial-submenu").style.display="flex",N=!1,qe=!0,ae=0,D=!1,Yi()}function bo(){document.getElementById("tutorial-submenu").style.display="none",qe=!1,ue()}function To(e){const t=document.getElementById("tutorial-glossary"),a=document.getElementById("tutorial-content-area"),n=document.getElementById("section-"+e),i=document.getElementById("back-to-glossary");t&&a&&n&&(t.style.display="none",a.style.display="flex",i&&(i.style.display="block"),setTimeout(()=>{n.scrollIntoView({behavior:"smooth",block:"start"})},100))}function Yi(){const e=document.getElementById("tutorial-glossary"),t=document.getElementById("tutorial-content-area"),a=document.getElementById("back-to-glossary");e&&t&&(t.style.display="none",e.style.display="block",a&&(a.style.display="none"),ae=0,setTimeout(()=>{Ca()},50))}function Eo(){if(!qe)return;const e=document.getElementById("tutorial-glossary");if(e&&e.style.display!=="none"){const n=e.querySelectorAll(".glossary-item");if(n.length===0)return;ae=(ae-1+n.length)%n.length,Ca();return}const t=document.getElementById("tutorial-content-area");if(!t||t.style.display!=="flex")return;const a=t.querySelector(".submenu-list.tutorial-content");a&&(a.scrollTop=Math.max(0,a.scrollTop-80))}function wo(){if(!qe)return;const e=document.getElementById("tutorial-glossary");if(e&&e.style.display!=="none"){const n=e.querySelectorAll(".glossary-item");if(n.length===0)return;ae=(ae+1)%n.length,Ca();return}const t=document.getElementById("tutorial-content-area");if(!t||t.style.display!=="flex")return;const a=t.querySelector(".submenu-list.tutorial-content");a&&(a.scrollTop=Math.min(a.scrollHeight-a.clientHeight,a.scrollTop+80))}function Ca(){const e=document.getElementById("tutorial-glossary");if(!e)return;const t=e.querySelectorAll(".glossary-item");if(t.length!==0&&(t.forEach(a=>{a.classList.remove("menu-selected")}),ae>=0&&ae<t.length)){const a=t[ae];a.classList.add("menu-selected"),a.scrollIntoView({behavior:"smooth",block:"nearest"})}}function Ta(){!h||!p||(ge=null,Ct=!1,xt=setInterval(()=>{if(!ce||Ct||!ze&&R.style.display==="block")return;Io()&&(console.log("Motion detected! Capturing..."),zt(),Ct=!0,setTimeout(()=>{if(Ct=!1,ge=null,R.style.display==="block"&&(R.style.display="none",h.style.display="block"),!ze){La(),ce=!1;const t=document.getElementById("motion-toggle");t.classList.remove("active"),t.title="Motion Detection: OFF",showStatus("Motion capture complete - Press eye button to reactivate",3e3)}},et*1e3))},500))}function La(){xt&&(clearInterval(xt),xt=null),ge=null}function Io(){if(!h||!p)return!1;const e=p.getContext("2d"),t=320,a=240;p.width=t,p.height=a,e.drawImage(h,0,0,t,a);const n=e.getImageData(0,0,t,a);if(!ge)return ge=n,!1;let i=0;const s=t*a;for(let r=0;r<n.data.length;r+=4){const l=Math.abs(n.data[r]-ge.data[r]),c=Math.abs(n.data[r+1]-ge.data[r+1]),u=Math.abs(n.data[r+2]-ge.data[r+2]);(l+c+u)/3>Ze&&i++}return ge=n,i/s>ka}function vo(){Je=!Je;const e=document.getElementById("random-toggle");Je?(e.classList.add("random-active"),y.textContent=`Random mode ON • ${m[T].name}`):(e.classList.remove("random-active"),z()),typeof PluginMessageHandler<"u"&&PluginMessageHandler.postMessage(JSON.stringify({action:"random_mode_toggled",enabled:Je,timestamp:Date.now()}))}function ko(){try{const e=localStorage.getItem(ki);e&&(I=JSON.parse(e))}catch(e){console.error("Error loading queue:",e),I=[]}}function Ot(){try{localStorage.setItem(ki,JSON.stringify(I))}catch(e){console.error("Error saving queue:",e)}}function fa(){Be&&(Q?(Be.className="connection-status online",Be.querySelector("#connection-text").textContent="Online"):(Be.className="connection-status offline",Be.querySelector("#connection-text").textContent="Offline"),Be.style.display="block"),st()}function st(){if(Xe){const e=I.length;Xe.querySelector("#queue-count").textContent=e,Xe.style.display=e>0?"block":"none"}if(le){const e=I.length;le.querySelector("#sync-count").textContent=e,le.style.display=e>0&&Q?"block":"none"}}function Ao(){window.addEventListener("online",()=>{Q=!0,fa(),console.log("Connection restored"),I.length>0&&!Ge&&setTimeout(()=>{y.textContent=`Connection restored! Syncing ${I.length} photos...`,Tt()},1e3)}),window.addEventListener("offline",()=>{Q=!1,fa(),console.log("Connection lost"),Ge&&(y.textContent="Connection lost during sync")}),fa()}async function Ro(){try{return A=(await navigator.mediaDevices.enumerateDevices()).filter(t=>t.kind==="videoinput"),console.log("Available cameras:",A.length),A}catch(e){return console.error("Error enumerating cameras:",e),[]}}function aa(){const e=Et[ye];if(A.length===0)return{video:{facingMode:"environment",width:{ideal:e.width},height:{ideal:e.height}}};const a={video:{deviceId:{exact:A[F].deviceId},width:{ideal:e.width},height:{ideal:e.height}}};return Ye()&&(a.video.advanced=[{zoom:1}]),a}async function Oo(e){if(!(e===ye||!k)){ye=e,qs(e);try{y.textContent="Changing resolution...",k&&k.getTracks().forEach(a=>a.stop());const t=aa();k=await navigator.mediaDevices.getUserMedia(t),h.srcObject=k,j=k.getVideoTracks()[0],setTimeout(()=>{At()},100),await new Promise(a=>{h.onloadedmetadata=async()=>{try{await h.play(),bt(),await ot(P),setTimeout(a,100)}catch(n){console.error("Video play error:",n),a()}}}),z(),typeof PluginMessageHandler<"u"&&PluginMessageHandler.postMessage(JSON.stringify({action:"resolution_changed",resolution:Et[ye].name,timestamp:Date.now()}))}catch(t){console.error("Resolution change error:",t),y.textContent="Resolution change failed"}}}function Ea(){if(A.length===0)return"Default Camera";const e=A[F];let t=e.label;return!t||t===""?e.deviceId?t=`Camera ${F+1}`:t="Unknown Camera":(t=t.replace(/\([^)]*\)/g,"").trim(),t.toLowerCase().includes("front")?t="Front Camera":t.toLowerCase().includes("back")||t.toLowerCase().includes("rear")?t="Back Camera":t.length>20&&(t=t.substring(0,17)+"...")),t}function Ye(){if(A.length===0)return!1;const e=A[F];if(!e)return!1;const t=e.label.toLowerCase();return e.facingMode==="user"?!0:e.facingMode==="environment"?!1:t.includes("front")||t.includes("user")||t.includes("selfie")||t.includes("face")?!0:t.includes("back")||t.includes("rear")||t.includes("environment")?!1:A.length===2?F===1:F>0}function bt(){try{Ye()?(h.style.transform="translateZ(0)",h.style.webkitTransform="translateZ(0)"):(h.style.transform="scaleX(-1) translateZ(0)",h.style.webkitTransform="scaleX(-1) translateZ(0)")}catch(e){console.warn("Mirror transform skipped:",e)}}function So(){if(!j)return!1;const e=j.getCapabilities();return e&&"zoom"in e}function zi(){if(!j)return{min:1,max:5,step:.1};const e=j.getCapabilities();return e&&e.zoom?{min:Math.min(e.zoom.min||1,1),max:Math.max(e.zoom.max||5,5),step:e.zoom.step||.1}:{min:1,max:5,step:.1}}async function ot(e){if(j)try{if(So()){const t=zi(),a=Math.max(t.min,Math.min(e,t.max)),n={advanced:[{zoom:a}]},i=j.getCapabilities();i&&i.focusMode&&i.focusMode.includes("continuous")&&(n.advanced[0].focusMode="continuous"),await j.applyConstraints(n),P=a,Ye()?(h.style.transform="translateZ(0)",h.style.webkitTransform="translateZ(0)"):(h.style.transform="scaleX(-1) translateZ(0)",h.style.webkitTransform="scaleX(-1) translateZ(0)")}else{const t=Math.max(1,Math.min(e,5));P=t,Ye()?(h.style.transform=`scale(${t})`,h.style.webkitTransform=`scale(${t})`):(h.style.transform=`scaleX(-1) scale(${t})`,h.style.webkitTransform=`scaleX(-1) scale(${t})`)}}catch{const a=Math.max(1,Math.min(e,5));P=a,Ye()?(h.style.transform=`scale(${a})`,h.style.webkitTransform=`scale(${a})`):(h.style.transform=`scaleX(-1) scale(${a})`,h.style.webkitTransform=`scaleX(-1) scale(${a})`)}}async function wa(){if(j)try{const e=j.getCapabilities();e&&e.focusMode&&(e.focusMode.includes("single-shot")?(await j.applyConstraints({advanced:[{focusMode:"single-shot",zoom:P}]}),console.log("Triggered single-shot focus"),setTimeout(async()=>{try{await j.applyConstraints({advanced:[{focusMode:"continuous",zoom:P}]})}catch(t){console.log("Could not return to continuous focus:",t)}},500)):e.focusMode.includes("manual")&&(await j.applyConstraints({advanced:[{focusMode:"manual",zoom:P}]}),console.log("Triggered manual focus")))}catch(e){console.log("Focus adjustment not supported or failed:",e)}}async function No(){if(ua||A.length<=1){console.log("Cannot switch camera: loading or not enough cameras");return}ua=!0;try{y.textContent="Switching camera...",k&&k.getTracks().forEach(t=>t.stop()),F=(F+1)%A.length,console.log(`Switching to camera ${F+1} of ${A.length}`);const e=aa();k=await navigator.mediaDevices.getUserMedia(e),h.srcObject=k,j=k.getVideoTracks()[0],setTimeout(()=>{At()},100),await new Promise(t=>{h.onloadedmetadata=async()=>{try{await h.play(),bt(),await ot(P),setTimeout(t,100)}catch(a){console.error("Video play error:",a),t()}}}),z(),typeof PluginMessageHandler<"u"&&PluginMessageHandler.postMessage(JSON.stringify({action:"camera_switched",cameraIndex:F,cameraLabel:Ea(),timestamp:Date.now()}))}catch(e){console.error("Camera switch error:",e),y.textContent="Camera switch failed",F=(F-1+A.length)%A.length}finally{ua=!1}}function Co(){try{const e=localStorage.getItem(ui);if(e){const t=JSON.parse(e);M=t.count||5;const a=t.speed||2;wt=Qe[a].delay}}catch(e){console.error("Error loading burst settings:",e)}}function si(e,t){try{localStorage.setItem(ui,JSON.stringify({count:e,speed:t}))}catch(a){console.error("Error saving burst settings:",a)}}function Lo(){Re=!Re;const e=document.getElementById("burst-toggle");Re?(e.classList.add("burst-active"),y.textContent=`Burst mode ON (${M} photos) • ${m[T].name}`):(e.classList.remove("burst-active"),z()),typeof PluginMessageHandler<"u"&&PluginMessageHandler.postMessage(JSON.stringify({action:"burst_mode_toggled",enabled:Re,count:M,timestamp:Date.now()}))}function Mo(){Oe=!Oe;const e=document.getElementById("timer-toggle");Oe?(e.classList.add("timer-active"),y.textContent=`Timer mode ON (${de}s delay) • ${m[T].name}`):(e.classList.remove("timer-active"),be&&(clearInterval(be),be=null,document.getElementById("timer-countdown").style.display="none"),z()),typeof PluginMessageHandler<"u"&&PluginMessageHandler.postMessage(JSON.stringify({action:"timer_mode_toggled",enabled:Oe,delay:de,timestamp:Date.now()}))}function Ia(e){let t=de;const a=document.getElementById("timer-countdown"),n=document.getElementById("timer-countdown-text");n.textContent=t,a.style.display="flex",a.classList.remove("countdown-fade-out"),a.classList.add("countdown-fade-in"),y.textContent=`Timer: ${t}s...`,be=setInterval(()=>{t--,t>0?(a.classList.remove("countdown-fade-in"),a.classList.add("countdown-fade-out"),setTimeout(()=>{n.textContent=t,a.classList.remove("countdown-fade-out"),a.classList.add("countdown-fade-in"),y.textContent=`Timer: ${t}s...`},500)):(a.classList.remove("countdown-fade-in"),a.classList.add("countdown-fade-out"),setTimeout(()=>{a.style.display="none",a.classList.remove("countdown-fade-out"),clearInterval(be),be=null,e(),We&&Oe&&(setTimeout(()=>{if(R.style.display==="block"){R.style.display="none",h.style.display="block";const i=document.getElementById("camera-button");i&&A.length>1&&(i.style.display="flex")}},500),setTimeout(()=>{Oe&&Ia(e)},q*1e3))},500))},1e3)}function Vi(){be&&(clearInterval(be),be=null,document.getElementById("timer-countdown").style.display="none",z())}function jo(){try{const e=localStorage.getItem(mi);if(e){const t=JSON.parse(e);de=t.delay||10,We=t.repeat||!1,q=t.repeatInterval||1}}catch(e){console.error("Error loading timer settings:",e)}}function ya(){try{localStorage.setItem(mi,JSON.stringify({delay:de,repeat:We,repeatInterval:q}))}catch(e){console.error("Error saving timer settings:",e)}}function ut(){const e=document.getElementById("current-timer-display");if(e){const t=We?`Repeat (${fi[xo()].label})`:"No Repeat";e.textContent=`${de}s, ${t}`}}function xo(){for(const[e,t]of Object.entries(fi))if(t.seconds===q)return parseInt(e);return 1}async function oi(){if(!(!k||ma||R.style.display==="block")){ma=!0,y.textContent=`Burst mode: Taking ${M} photos...`;for(let e=0;e<M;e++)y.textContent=`Burst ${e+1}/${M}...`,Po(e+1),e<M-1&&await new Promise(t=>setTimeout(t,wt));ma=!1,y.textContent=`Burst complete! ${M} photos saved.`,Q&&!Ge?setTimeout(()=>{Tt()},500):Q||(y.textContent=`Burst complete! ${M} photos queued (offline).`),typeof PluginMessageHandler<"u"&&PluginMessageHandler.postMessage(JSON.stringify({action:"burst_complete",count:M,timestamp:Date.now()})),setTimeout(()=>{Re?y.textContent=`Burst mode ON (${M} photos) • ${m[T].name}`:z()},2e3)}}function Po(e){if(!k)return;Je&&(T=Hi()),p.width=h.videoWidth,p.height=h.videoHeight;const t=p.getContext("2d",{willReadFrequently:!1,alpha:!1});t.clearRect(0,0,p.width,p.height);const a=p.width/P,n=p.height/P,i=(p.width-a)/2,s=(p.height-n)/2;if(Ye())t.drawImage(h,i,s,a,n,0,0,p.width,p.height);else{t.save(),t.scale(-1,1),t.drawImage(h,i,s,a,n,-p.width,0,p.width,p.height),t.restore();const u=document.createElement("canvas");u.width=p.width,u.height=p.height;const f=u.getContext("2d");f.scale(-1,1),f.drawImage(p,-p.width,0),t.clearRect(0,0,p.width,p.height),t.drawImage(u,0,0)}Pi(t,p.width,p.height);const o=ye>=2?.7:.8,r=p.toDataURL("image/jpeg",o),l=m[T];Ci(r);const c={id:Date.now().toString()+"-"+e,imageBase64:r,preset:l,timestamp:Date.now()};I.push(c),Ot(),st()}async function Do(){try{if(h=document.getElementById("video"),p=document.getElementById("canvas"),R=document.getElementById("captured-image"),y=document.getElementById("status"),Dt=document.getElementById("reset-button"),document.getElementById("start-screen").querySelector(".start-text").textContent="Loading camera...",document.getElementById("start-button").disabled=!0,await Ro(),A.length>1){const l=A.findIndex(c=>{const u=c.label.toLowerCase();return u.includes("back")||u.includes("rear")||u.includes("environment")});F=l!==-1?l:A.length-1}else F=0;const e=aa();k=await navigator.mediaDevices.getUserMedia(e),h.srcObject=k,j=k.getVideoTracks()[0],setTimeout(()=>{At()},100),console.log("Camera initialized:",Ea()),ko(),Ao(),await new Promise(l=>{h.onloadedmetadata=async()=>{try{await h.play(),bt(),ot(1),h.addEventListener("playing",bt),setTimeout(l,100)}catch(c){console.error("Video play error:",c),l()}}}),document.getElementById("start-screen").style.display="none",document.getElementById("camera-container").style.display="flex",y.style.display="block";const t=document.getElementById("camera-button");A.length>1&&(t.style.display="flex");const a=document.getElementById("menu-button");a&&(a.style.display="flex");const n=document.getElementById("burst-toggle");n&&(n.style.display="flex");const i=document.getElementById("random-toggle");i&&(i.style.display="flex");const s=document.getElementById("timer-toggle");s&&(s.style.display="flex");const o=document.getElementById("motion-toggle");o&&(o.style.display="flex");const r=document.getElementById("gallery-button");r&&(r.style.display="flex"),z(),typeof PluginMessageHandler<"u"&&PluginMessageHandler.postMessage(JSON.stringify({status:"camera_ready",availableCameras:A.length,currentCamera:Ea(),timestamp:Date.now()}))}catch(e){console.error("Camera access error:",e),y.textContent="Camera access denied",typeof PluginMessageHandler<"u"&&PluginMessageHandler.postMessage(JSON.stringify({status:"camera_error",error:e.message,timestamp:Date.now()}))}}function xe(){k&&h&&(k.getTracks().forEach(e=>{e.stop()}),h.style.display="none",h.srcObject=null)}async function Wi(){if(h)try{const e=aa();k=await navigator.mediaDevices.getUserMedia(e),h.srcObject=k,j=k.getVideoTracks()[0],setTimeout(()=>{At()},100),await new Promise(t=>{h.onloadedmetadata=async()=>{try{await h.play(),bt(),await ot(P),setTimeout(t,100)}catch(a){console.error("Video resume error:",a),t()}}}),h.style.display="block"}catch(e){console.error("Failed to resume camera:",e),y.textContent="Camera resume failed"}}function zt(){if(!k)return;Je&&(T=Hi(),Aa(m[T].name)),p.width=h.videoWidth,p.height=h.videoHeight;const e=p.getContext("2d",{willReadFrequently:!1,alpha:!1});e.clearRect(0,0,p.width,p.height);const t=p.width/P,a=p.height/P,n=(p.width-t)/2,i=(p.height-a)/2;if(Ye())e.drawImage(h,n,i,t,a,0,0,p.width,p.height);else{e.save(),e.scale(-1,1),e.drawImage(h,n,i,t,a,-p.width,0,p.width,p.height),e.restore();const f=document.createElement("canvas");f.width=p.width,f.height=p.height;const v=f.getContext("2d");v.scale(-1,1),v.drawImage(p,-p.width,0),e.clearRect(0,0,p.width,p.height),e.drawImage(f,0,0)}Pi(e,p.width,p.height);const s=ye>=2?.7:.8,o=p.toDataURL("image/jpeg",s);R.src=o,R.style.display="block",R.style.transform="none",h.style.display="none",ce||Oe&&We?Dt.style.display="none":Dt.style.display="block";const r=document.getElementById("camera-button");r&&(r.style.display="none");const l=document.getElementById("resolution-button");l&&(l.style.display="none"),Ci(o);const c=m[T],u={id:Date.now().toString(),imageBase64:o,preset:c,timestamp:Date.now()};if(I.push(u),Ot(),st(),Q){const f=H?"Photo saved!":"Photo saved! Uploading...";y.textContent=f,Ge||Tt()}else y.textContent=`Photo queued for sync (${I.length} in queue)`;typeof PluginMessageHandler<"u"&&PluginMessageHandler.postMessage(JSON.stringify({action:"photo_captured",queued:!0,queueLength:I.length,timestamp:Date.now()}))}async function Tt(){if(I.length===0||Ge)return;if(!Q){y.textContent="Cannot sync - offline";return}Ge=!0,le.disabled=!0,le.classList.add("syncing"),console.log(`Syncing ${I.length} queued photos...`);const e=I.length;let t=0;for(;I.length>0&&Q;){const a=I[0];try{if(y.textContent=`Syncing ${t+1}/${e}...`,typeof PluginMessageHandler<"u"&&!H&&PluginMessageHandler.postMessage(JSON.stringify({message:sa(a.preset.message),pluginId:"com.r1.pixelart",imageBase64:a.imageBase64})),await new Promise(n=>setTimeout(n,2e3)),Q)I.shift(),t++,Ot(),st();else{console.log("Lost connection during sync");break}await new Promise(n=>setTimeout(n,2e3))}catch(n){console.error("Sync error:",n),y.textContent="Sync error - will retry later";break}}if(Ge=!1,le.disabled=!1,le.classList.remove("syncing"),I.length===0){const a=H?`All ${t} photos saved!`:`All ${t} photos synced successfully!`;y.textContent=a,setTimeout(()=>{z()},2e3)}else Q?y.textContent=`Synced ${t}. ${I.length} remaining.`:y.textContent=`Connection lost. ${I.length} photos queued.`;typeof PluginMessageHandler<"u"&&PluginMessageHandler.postMessage(JSON.stringify({action:"sync_complete",synced:t,remaining:I.length,timestamp:Date.now()}))}function Ma(){const e=document.getElementById("queue-manager"),t=document.getElementById("queue-list");t.innerHTML="",I.length===0?t.innerHTML=`
    ...
    `:I.forEach((a,n)=>{const i=document.createElement("div");i.className="queue-item",i.innerHTML=`
      ...
      `,t.appendChild(i)}),e.style.display="flex"}function Uo(){document.getElementById("queue-manager").style.display="none"}function Bo(e){confirm("Remove this photo from the sync queue?")&&(I.splice(e,1),Ot(),st(),Ma())}function Ho(e){const t=I[e];alert(`Style: ${t.preset.name}
Prompt: ${t.preset.message}
Saved: ${new Date(t.timestamp).toLocaleString()}`)}function qi(){confirm("Clear all photos from the queue? This cannot be undone.")&&(I=[],Ot(),st(),Ma())}window.addEventListener("sideClick",()=>{if(console.log("Side button pressed"),D){const n=document.getElementById("settings-submenu").querySelectorAll(".menu-section-button");n.length>0&&ee<n.length&&n[ee].click();return}if(Ie){mo();return}if(qe){const a=document.getElementById("tutorial-glossary");if(a&&a.style.display!=="none"){const n=a.querySelectorAll(".glossary-item");n.length>0&&ae<n.length&&n[ae].click()}return}if(It){const n=document.getElementById("resolution-submenu").querySelectorAll(".resolution-item");n.length>0&&te<n.length&&n[te].click();return}if(he){Cs();return}if(N&&je){zs();return}const e=document.getElementById("start-screen"),t=document.getElementById("start-button");if(e&&e.style.display!=="none")console.log("Simulating tap on start button"),setTimeout(()=>{t.click()},100);else if(R&&R.style.display==="block")na();else{if(ce){if(tt>0){let a=tt;const n=document.getElementById("timer-countdown"),i=document.getElementById("timer-countdown-text");i.textContent=a,n.style.display="flex",n.classList.remove("countdown-fade-out"),n.classList.add("countdown-fade-in"),y.textContent=`Motion Detection starting in ${a}s...`,ct=setInterval(()=>{a--,a>0?(n.classList.remove("countdown-fade-in"),n.classList.add("countdown-fade-out"),setTimeout(()=>{i.textContent=a,n.classList.remove("countdown-fade-out"),n.classList.add("countdown-fade-in"),y.textContent=`Motion Detection starting in ${a}s...`},500)):(n.classList.remove("countdown-fade-in"),n.classList.add("countdown-fade-out"),setTimeout(()=>{n.style.display="none",n.classList.remove("countdown-fade-out"),clearInterval(ct),ce&&h&&h.readyState>=2&&(Ta(),showStatus("Motion Detection active - Move in front of camera",3e3))},500))},1e3)}else Ta(),showStatus("Motion Detection ON - Move in front of camera",3e3);return}Oe?Ia(Re?()=>oi():()=>zt()):Re?oi():zt()}});window.addEventListener("scrollUp",()=>{var t,a,n,i;if(console.log("Scroll wheel: up"),he){ls();return}if(qe){Eo();return}if(nt){Li();return}if(Ie){ho();return}if(N&&je){Gs();return}if(Xt){Es();return}if(Jt){bs();return}if(Kt){fs();return}if(qt){gs();return}if(It){us();return}if(D){ds();return}if(((t=document.getElementById("gallery-modal"))==null?void 0:t.style.display)==="flex"){Is();return}if(((a=document.getElementById("image-viewer"))==null?void 0:a.style.display)==="flex"){ks();return}if(((n=document.getElementById("style-editor"))==null?void 0:n.style.display)==="flex"){Rs();return}if(((i=document.getElementById("queue-manager"))==null?void 0:i.style.display)==="flex"){Ss();return}if(!k||R.style.display==="block")return;const e=Date.now();e-Ht<vi||(Ht=e,Ne&&clearTimeout(Ne),Ne=setTimeout(()=>{let s=Ui();const o=Rt();s=(s-1+o.length)%o.length,T=Bi(s);const r=m[T];r&&Aa(r.name),z(),typeof PluginMessageHandler<"u"&&PluginMessageHandler.postMessage(JSON.stringify({action:"preset_changed",preset:m[T].name,timestamp:Date.now()})),Ne=null},50))});window.addEventListener("scrollDown",()=>{var t,a,n,i;if(console.log("Scroll wheel: down"),he){cs();return}if(qe){wo();return}if(nt){Mi();return}if(Ie){uo();return}if(N&&je){Ys();return}if(Xt){ws();return}if(Jt){Ts();return}if(Kt){ys();return}if(qt){ps();return}if(It){ms();return}if(D){hs();return}if(((t=document.getElementById("gallery-modal"))==null?void 0:t.style.display)==="flex"){vs();return}if(((a=document.getElementById("image-viewer"))==null?void 0:a.style.display)==="flex"){As();return}if(((n=document.getElementById("style-editor"))==null?void 0:n.style.display)==="flex"){Os();return}if(((i=document.getElementById("queue-manager"))==null?void 0:i.style.display)==="flex"){Ns();return}if(!k||R.style.display==="block")return;const e=Date.now();e-Ht<vi||(Ht=e,Ne&&clearTimeout(Ne),Ne=setTimeout(()=>{let s=Ui();const o=Rt();s=(s+1)%o.length,T=Bi(s);const r=m[T];r&&Aa(r.name),z(),typeof PluginMessageHandler<"u"&&PluginMessageHandler.postMessage(JSON.stringify({action:"preset_changed",preset:m[T].name,timestamp:Date.now()})),Ne=null},50))});function z(){T=Math.max(0,Math.min(T,m.length-1));const e=m[T];if(j)try{const t={};j.applyConstraints(t)}catch(t){console.error("Error applying preset constraints:",t)}y&&(y.textContent=`Style: ${e.name}`),localStorage.setItem(gi,T.toString()),N&&it()}window.onPluginMessage=function(e){console.log("Received plugin message:",e),e&&e.status==="processing"?y.textContent="AI is processing your image...":e&&e.status==="complete"?y.textContent="AI transformation complete!":e&&e.error&&(y.textContent="Error: "+e.error)};typeof PluginMessageHandler<"u"?(console.log("Flutter channel is available"),PluginMessageHandler.postMessage(JSON.stringify({message:"AI Camera Styles initialized",pluginId:"com.r1.pixelart"}))):console.log("Running in development mode - Flutter channel not available");function na(){R.style.display="none",ce&&ze||(La(),ce&&Ta()),R.style.transform="none",h.style.display="block",Dt.style.display="none";const e=document.getElementById("camera-button");e&&A.length>1&&(e.style.display="flex");const t=document.getElementById("resolution-button");t&&(t.style.display="flex"),setTimeout(()=>{ot(P)},50),z()}function ri(e,t){const a=e.clientX-t.clientX,n=e.clientY-t.clientY;return Math.sqrt(a*a+n*n)}function Fo(){const e=document.getElementById("video");e.addEventListener("touchstart",a=>{a.touches.length===2&&(a.preventDefault(),rt=!0,_n=ri(a.touches[0],a.touches[1]),$n=P)},{passive:!1});let t=null;e.addEventListener("touchmove",a=>{if(rt&&a.touches.length===2){a.preventDefault();const i=ri(a.touches[0],a.touches[1])/_n,s=$n*i,o=zi(),r=Math.max(o.min,Math.min(s,o.max));t||(ot(r),t=setTimeout(()=>{t=null},50))}},{passive:!1}),e.addEventListener("touchend",a=>{a.touches.length<2&&(rt&&wa(),rt=!1,console.log("Pinch ended, current zoom:",P))}),e.addEventListener("touchcancel",()=>{rt=!1})}function Go(){const e=document.getElementById("video");let t=null,a=!1;e.addEventListener("touchstart",n=>{!N&&R.style.display==="none"&&(a=!1,t=setTimeout(()=>{a=!0;const i=n.touches[0],s=e.getBoundingClientRect(),o=i.clientX-s.left,r=i.clientY-s.top,l=document.createElement("div");l.style.position="absolute",l.style.left=o+"px",l.style.top=r+"px",l.style.width="80px",l.style.height="80px",l.style.border="3px solid #4CAF50",l.style.borderRadius="50%",l.style.transform="translate(-50%, -50%)",l.style.pointerEvents="none",l.style.animation="capturePulse 0.4s ease-out",l.style.zIndex="150",l.style.backgroundColor="rgba(76, 175, 80, 0.2)",document.getElementById("camera-container").appendChild(l),setTimeout(()=>{l.remove()},400),zt(),navigator.vibrate&&navigator.vibrate(50)},500))}),e.addEventListener("touchend",n=>{if(t&&(clearTimeout(t),t=null),!a&&!N&&R.style.display==="none"){wa();const i=n.changedTouches[0],s=e.getBoundingClientRect(),o=i.clientX-s.left,r=i.clientY-s.top,l=document.createElement("div");l.style.position="absolute",l.style.left=o+"px",l.style.top=r+"px",l.style.width="60px",l.style.height="60px",l.style.border="2px solid #FE5F00",l.style.borderRadius="50%",l.style.transform="translate(-50%, -50%)",l.style.pointerEvents="none",l.style.animation="focusPulse 0.6s ease-out",l.style.zIndex="150",document.getElementById("camera-container").appendChild(l),setTimeout(()=>{l.remove()},600)}}),e.addEventListener("touchcancel",n=>{t&&(clearTimeout(t),t=null)}),e.addEventListener("click",n=>{if(!N&&R.style.display==="none"){wa();const i=e.getBoundingClientRect(),s=n.clientX-i.left,o=n.clientY-i.top,r=document.createElement("div");r.style.position="absolute",r.style.left=s+"px",r.style.top=o+"px",r.style.width="60px",r.style.height="60px",r.style.border="2px solid #FE5F00",r.style.borderRadius="50%",r.style.transform="translate(-50%, -50%)",r.style.pointerEvents="none",r.style.animation="focusPulse 0.6s ease-out",r.style.zIndex="150",document.getElementById("camera-container").appendChild(r),setTimeout(()=>{r.remove()},600)}})}function ia(){const e=document.getElementById("unified-menu");R&&R.style.display==="block"&&na(),Ee();const t=document.getElementById("styles-count");if(t){const{favorites:a,regular:n}=ft(),i=a.length+n.length;t.textContent=i}Ki(),Vt(),Wt(),ut(),N=!0,je=!0,xe(),Vi(),e.style.display="flex"}async function ja(){N=!1,je=!1,U=0,Ae="",pe="",document.getElementById("style-filter").value="";const e=document.getElementById("menu-category-hint");e&&(e.style.display="none"),document.getElementById("unified-menu").style.display="none",await Wi()}function ue(){const e=document.getElementById("settings-submenu"),t=document.getElementById("unified-menu");Ki(),Vt(),ut(),Wt(),t.style.display="none",xe(),e.style.display="flex",N=!1,D=!0,ee=0,setTimeout(()=>{Oa()},50)}function Yo(){document.getElementById("settings-submenu").style.display="none",D=!1,ee=0,ia()}function zo(){const e=document.getElementById("timer-settings-submenu"),t=document.getElementById("settings-submenu"),a=document.getElementById("timer-delay-slider"),n=document.getElementById("timer-delay-value"),i=document.getElementById("timer-repeat-enabled");if(a&&n){const r=pi.indexOf(de);a.value=r!==-1?r+1:3,n.textContent=de}i&&(i.checked=We);const s=document.getElementById("timer-repeat-interval-input"),o=document.getElementById("timer-repeat-interval-unit");s&&o&&(q>=3600&&q%3600===0?(s.value=q/3600,o.value="3600"):q>=60&&q%60===0?(s.value=q/60,o.value="60"):(s.value=q,o.value="1")),t.style.display="none",xe(),e.style.display="flex",Kt=!0,D=!1}function Vo(){document.getElementById("timer-settings-submenu").style.display="none",Kt=!1,ue()}function Wo(){const e=document.querySelector(".styles-menu-scroll-container");e&&(e.scrollTo({top:0,behavior:"smooth"}),U=0,it())}function qo(){const e=document.querySelector(".styles-menu-scroll-container");if(e){e.scrollTo({top:e.scrollHeight,behavior:"smooth"});const t=document.getElementById("menu-styles-list");if(t){const a=t.querySelectorAll(".style-item");a.length>0&&(U=a.length-1,it())}}}function Ki(){const e=document.getElementById("current-resolution-display");if(e){const t=Et[ye];e.textContent=`${t.width}x${t.height}`}}function Vt(){const e=document.getElementById("current-burst-display");if(e){let t="Medium";for(const[a,n]of Object.entries(Qe))if(n.delay===wt){t=n.label;break}e.textContent=`${M} photos, ${t}`}}function Ko(){document.getElementById("settings-submenu").style.display="none",xe();const e=document.getElementById("resolution-submenu"),t=document.getElementById("resolution-list");t.innerHTML="",Et.forEach((a,n)=>{const i=document.createElement("div");i.className="resolution-item",n===ye&&i.classList.add("active");const s=document.createElement("span");s.className="resolution-name",s.textContent=a.name,i.appendChild(s),i.onclick=()=>{Oo(n),Ji()},t.appendChild(i)}),e.style.display="flex",It=!0,D=!1,te=0,setTimeout(()=>{const a=e.querySelectorAll(".resolution-item");Sa(a)},100)}async function Ji(){document.getElementById("resolution-submenu").style.display="none",It=!1,te=0,ue()}function Jo(){document.getElementById("settings-submenu").style.display="none",xe();const e=document.getElementById("burst-submenu"),t=document.getElementById("burst-count-slider"),a=document.getElementById("burst-speed-slider"),n=document.getElementById("burst-count-value"),i=document.getElementById("burst-speed-value");if(t&&n&&(t.value=M,n.textContent=M),a&&i){let s=2;for(const[o,r]of Object.entries(Qe))if(r.delay===wt){s=parseInt(o);break}a.value=s,i.textContent=Qe[s].label}e.style.display="flex",qt=!0,D=!1}async function Xo(){document.getElementById("burst-submenu").style.display="none",qt=!1,ue()}function _o(){document.getElementById("settings-submenu").style.display="none",xe();const e=document.getElementById("master-prompt-submenu"),t=document.getElementById("master-prompt-enabled"),a=document.getElementById("master-prompt-text"),n=document.getElementById("master-prompt-char-count");t&&(t.checked=we),a&&(a.value=Z,a.disabled=!we,n&&(n.textContent=Z.length)),e.style.display="flex",Jt=!0,D=!1}async function $o(){document.getElementById("master-prompt-submenu").style.display="none",Jt=!1,ue()}function Qo(){document.getElementById("settings-submenu").style.display="none",xe();const e=document.getElementById("aspect-ratio-submenu");e.style.display="flex",D=!1}async function Zo(){document.getElementById("aspect-ratio-submenu").style.display="none",ue()}function li(){const e=document.getElementById("current-aspect-ratio-display");e&&(e.textContent=G==="none"?"None":G)}function Wt(){const e=document.getElementById("current-master-prompt-display");if(e)if(we&&Z.trim()){const t=Z.substring(0,20);e.textContent=`Enabled: ${t}${Z.length>20?"...":""}`}else we?e.textContent="Enabled (empty)":e.textContent="Disabled"}function jt(){try{localStorage.setItem(yi,Z),localStorage.setItem(bi,we.toString()),localStorage.setItem(Ti,G)}catch(e){console.error("Failed to save master prompt:",e)}}function er(){try{const e=localStorage.getItem(yi),t=localStorage.getItem(bi);e!==null&&(Z=e),t!==null&&(we=t==="true");const a=localStorage.getItem(Ti);if(a){G=a;const n=document.getElementById("aspect-ratio-1-1"),i=document.getElementById("aspect-ratio-16-9");n&&(n.checked=G==="1:1"),i&&(i.checked=G==="16:9");const s=document.getElementById("current-aspect-ratio-display");s&&(s.textContent=G==="none"?"None":G)}}catch(e){console.error("Failed to load master prompt:",e)}}function sa(e){let t=e;return we&&Z.trim()&&(t=`${e} ${Z}`),t+=`

GLOBAL RANDOMIZATION DIRECTIVE (CRITICAL):
- Any section labeled RANDOM, SELECT, or CHOOSE must use the RANDOM SEED below
- The same seed must influence all internal selections in this render
- Different seeds must produce different outcomes
- Do not reuse prior selections across renders
RANDOM SEED: ${Date.now()}`,G==="1:1"?t+=" Use a square aspect ratio.":G==="16:9"&&(t+=" Use a square aspect ratio, but pad the image with black bars at top and bottom to simulate a 16:9 aspect ratio."),t}function Ee(e=!1){const t=document.getElementById("menu-styles-list");t.innerHTML="",t.replaceWith(t.cloneNode(!1));const a=document.getElementById("menu-styles-list"),n=document.createDocumentFragment(),{favorites:i,regular:s}=ft(),o=i.filter(c=>{if(Ae){const u=Ae.toLowerCase(),f=c.category&&c.category.some(w=>w.toLowerCase().includes(u));if(!(c.name.toLowerCase().includes(u)||c.message.toLowerCase().includes(u)||f))return!1}return pe?c.category&&c.category.includes(pe):!0}),r=s.filter(c=>{if(Ae){const u=Ae.toLowerCase(),f=c.category&&c.category.some(w=>w.toLowerCase().includes(u));if(!(c.name.toLowerCase().includes(u)||c.message.toLowerCase().includes(u)||f))return!1}return pe?c.category&&c.category.includes(pe):!0});if(o.length>0){const c=document.createElement("h3");c.className="menu-section-header",c.textContent="★ Favorites",n.appendChild(c),o.forEach(u=>{const f=ci(u);n.appendChild(f)})}if(r.length>0){const c=document.createElement("h3");c.className="menu-section-header",c.textContent=Ae?"Search Results":"All Styles",n.appendChild(c),r.forEach(u=>{const f=ci(u);n.appendChild(f)})}if(r.length===0&&o.length===0&&Ae){const c=document.createElement("div");c.className="menu-empty",c.textContent="No styles found",n.appendChild(c)}a.appendChild(n),a.addEventListener("click",tr);const l=document.getElementById("styles-count");if(l){const{favorites:c,regular:u}=ft(),f=c.length+u.length;l.textContent=f}e||(U=0,it())}function ci(e){const t=m.findIndex(r=>r===e),a=document.createElement("div");a.className="style-item",a.dataset.index=t,t===T&&a.classList.add("active");const n=document.createElement("button");n.className="style-favorite",n.textContent=at(e.name)?"⭐":"☆",n.dataset.action="favorite",n.dataset.styleName=e.name;const i=document.createElement("span");i.className="style-name",i.textContent=e.name;const s=document.createElement("button");s.className="style-edit";const o=e.internal===!1;return s.textContent=o?"Builder":"Edit",s.dataset.action=o?"builder":"edit",s.dataset.index=t,a.appendChild(n),a.appendChild(i),a.appendChild(s),a}function tr(e){const t=e.target;if(t.dataset.action==="favorite"){e.stopPropagation();const n=t.dataset.styleName;$s(n);return}if(t.dataset.action==="edit"){e.stopPropagation();const n=parseInt(t.dataset.index);nr(n);return}if(t.dataset.action==="builder"){e.stopPropagation();const n=parseInt(t.dataset.index);so(n);return}const a=t.closest(".style-item");if(a){const n=parseInt(a.dataset.index);isNaN(n)||(T=n,z(),ja())}}function ar(e="Add New Style"){const t=document.getElementById("style-editor");document.getElementById("editor-title").textContent=e,t.style.display="flex"}function xa(){document.getElementById("style-editor").style.display="none",document.getElementById("style-name").value="",document.getElementById("style-message").value="";const e=document.getElementById("style-category");e&&(e.value=""),document.getElementById("delete-style").style.display="none",Se=-1}function nr(e){Se=e;const t=m[e];document.getElementById("style-name").value=t.name,document.getElementById("style-message").value=t.message;const a=document.getElementById("style-category");a&&(a.value=t.category?t.category.join(", "):""),document.getElementById("delete-style").style.display="block",ar("Edit Style")}function ir(){const e=document.getElementById("style-name").value.trim(),t=document.getElementById("style-message").value.trim(),a=document.getElementById("style-category").value.trim(),n=a?a.split(",").map(i=>i.trim().toUpperCase()).filter(i=>i.length>0):[];if(!e||!t){alert("Please fill in both name and AI prompt");return}if(Se>=0){const i=m[Se].name;if(m[Se]={name:e,category:n,message:t},i!==e){const s=E.indexOf(i);s>-1&&(E[s]=e,Me())}}else m.push({name:e,category:n,message:t}),E.push(e),Me();ea(),alert(Se>=0?`Preset "${e}" updated!`:`Preset "${e}" saved!`),xa(),ia()}function sr(){Se>=0&&m.length>1&&confirm("Delete this style?")&&(m.splice(Se,1),T>=m.length&&(T=m.length-1),ea(),xa(),ia())}function or(){try{const e=new(window.AudioContext||window.webkitAudioContext),t=e.currentTime,a=e.createOscillator(),n=e.createGain(),i=e.createBiquadFilter();a.type="square",a.frequency.setValueAtTime(2400,t),a.frequency.exponentialRampToValueAtTime(1800,t+.012),i.type="highpass",i.frequency.setValueAtTime(1500,t),n.gain.setValueAtTime(.5,t),n.gain.exponentialRampToValueAtTime(.001,t+.015),a.connect(i),i.connect(n),n.connect(e.destination),a.start(t),a.stop(t+.015);const s=e.createOscillator(),o=e.createGain(),r=e.createBiquadFilter();s.type="square",s.frequency.setValueAtTime(1200,t+.015),s.frequency.exponentialRampToValueAtTime(200,t+.023),r.type="bandpass",r.frequency.setValueAtTime(1500,t+.015),r.Q.setValueAtTime(2,t+.015),o.gain.setValueAtTime(.4,t+.015),o.gain.exponentialRampToValueAtTime(.001,t+.03),s.connect(r),r.connect(o),o.connect(e.destination),s.start(t+.015),s.stop(t+.03);const l=e.createOscillator(),c=e.createGain();l.type="triangle",l.frequency.setValueAtTime(400,t+.023),l.frequency.setValueAtTime(450,t+.027),l.frequency.setValueAtTime(380,t+.031),l.frequency.setValueAtTime(420,t+.035),c.gain.setValueAtTime(0,t+.023),c.gain.linearRampToValueAtTime(.15,t+.025),c.gain.exponentialRampToValueAtTime(.001,t+.04),l.connect(c),c.connect(e.destination),l.start(t+.023),l.stop(t+.04);const u=e.createOscillator(),f=e.createGain(),v=e.createBiquadFilter();u.type="square",u.frequency.setValueAtTime(800,t+.05),u.frequency.exponentialRampToValueAtTime(150,t+.06),v.type="bandpass",v.frequency.setValueAtTime(1e3,t+.05),v.Q.setValueAtTime(2,t+.05),f.gain.setValueAtTime(.5,t+.05),f.gain.exponentialRampToValueAtTime(.001,t+.07),u.connect(v),v.connect(f),f.connect(e.destination),u.start(t+.05),u.stop(t+.07);const w=e.createOscillator(),O=e.createGain(),B=e.createBiquadFilter();w.type="sine",w.frequency.setValueAtTime(180,t+.05),w.frequency.exponentialRampToValueAtTime(120,t+.095),B.type="lowpass",B.frequency.setValueAtTime(300,t+.05),O.gain.setValueAtTime(0,t+.05),O.gain.linearRampToValueAtTime(.2,t+.055),O.gain.exponentialRampToValueAtTime(.001,t+.105),w.connect(B),B.connect(O),O.connect(e.destination),w.start(t+.05),w.stop(t+.105);const ie=e.sampleRate*.08,V=e.createBuffer(1,ie,e.sampleRate),ve=V.getChannelData(0);for(let Ue=0;Ue<ie;Ue++){const St=Math.sin(Ue/200)*.5+.5;ve[Ue]=(Math.random()*2-1)*St}const Pe=e.createBufferSource();Pe.buffer=V;const ke=e.createBiquadFilter();ke.type="bandpass",ke.frequency.setValueAtTime(3e3,t+.07),ke.Q.setValueAtTime(1,t+.07);const X=e.createGain();X.gain.setValueAtTime(0,t+.07),X.gain.linearRampToValueAtTime(.12,t+.075),X.gain.linearRampToValueAtTime(.12,t+.125),X.gain.exponentialRampToValueAtTime(.001,t+.15),Pe.connect(ke),ke.connect(X),X.connect(e.destination),Pe.start(t+.07),Pe.stop(t+.15);const _=e.createOscillator(),De=e.createGain();_.type="square",_.frequency.setValueAtTime(600,t+.145),_.frequency.exponentialRampToValueAtTime(100,t+.155),De.gain.setValueAtTime(.25,t+.145),De.gain.exponentialRampToValueAtTime(.001,t+.165),_.connect(De),De.connect(e.destination),_.start(t+.145),_.stop(t+.165)}catch(e){console.log("Audio generation failed:",e)}}window.addEventListener("load",()=>{Vs(),er(),Fo(),Go();const e=document.getElementById("start-button");e&&e.addEventListener("click",()=>{or();const d=document.querySelector(".camera-body");d&&(d.style.transition="all 0.1s",d.style.boxShadow="0 0 50px rgba(255, 255, 255, 1)",setTimeout(()=>{d.style.boxShadow=""},100));const g=document.querySelector(".lens-inner");g&&(g.style.transition="all 0.05s",g.style.transform="translate(-50%, -50%) scale(0.95)",setTimeout(()=>{g.style.transform="translate(-50%, -50%) scale(1)"},50)),setTimeout(()=>{Do()},300)});const t=document.getElementById("burst-toggle");t&&t.addEventListener("click",Lo);const a=document.getElementById("timer-toggle");a&&a.addEventListener("click",Mo);const n=document.getElementById("random-toggle");n&&n.addEventListener("click",vo);const i=document.getElementById("motion-toggle");i&&i.addEventListener("click",Zs);const s=document.getElementById("menu-button");s&&s.addEventListener("click",ia);const o=document.getElementById("close-menu");o&&o.addEventListener("click",ja);const r=document.getElementById("jump-to-top");r&&r.addEventListener("click",Wo);const l=document.getElementById("jump-to-bottom");l&&l.addEventListener("click",qo);const c=document.getElementById("settings-menu-button");c&&c.addEventListener("click",ue);const u=document.getElementById("settings-back");u&&u.addEventListener("click",Yo);const f=document.getElementById("resolution-settings-button");f&&f.addEventListener("click",Ko);const v=document.getElementById("resolution-back");v&&v.addEventListener("click",Ji);const w=document.getElementById("burst-settings-button");w&&w.addEventListener("click",Jo);const O=document.getElementById("burst-back");O&&O.addEventListener("click",Xo);const B=document.getElementById("timer-settings-button");B&&B.addEventListener("click",zo);const ie=document.getElementById("timer-settings-back");ie&&ie.addEventListener("click",Vo);const V=document.getElementById("master-prompt-settings-button");V&&V.addEventListener("click",_o);const ve=document.getElementById("master-prompt-back");ve&&ve.addEventListener("click",$o);const Pe=document.getElementById("aspect-ratio-settings-button");Pe&&Pe.addEventListener("click",Qo);const ke=document.getElementById("aspect-ratio-back");ke&&ke.addEventListener("click",Zo);const X=document.getElementById("aspect-ratio-1-1"),_=document.getElementById("aspect-ratio-16-9");X&&X.addEventListener("change",d=>{d.target.checked?(G="1:1",_&&(_.checked=!1)):G="none",jt(),li()}),_&&_.addEventListener("change",d=>{d.target.checked?(G="16:9",X&&(X.checked=!1)):G="none",jt(),li()});const De=document.getElementById("motion-settings-button");De&&De.addEventListener("click",to);const Ue=document.getElementById("motion-back");Ue&&Ue.addEventListener("click",ao);const St=document.getElementById("visible-presets-settings-button");St&&St.addEventListener("click",no);const Pa=document.getElementById("visible-presets-back");Pa&&Pa.addEventListener("click",io);const Da=document.getElementById("preset-builder-button");Da&&Da.addEventListener("click",Fi);const Ua=document.getElementById("preset-builder-back");Ua&&Ua.addEventListener("click",Na);const Ba=document.getElementById("preset-builder-jump-up");Ba&&Ba.addEventListener("click",Li);const Ha=document.getElementById("preset-builder-jump-down");Ha&&Ha.addEventListener("click",Mi);const Fa=document.getElementById("preset-builder-template");Fa&&Fa.addEventListener("change",oo);const Ga=document.getElementById("preset-builder-name");Ga&&Ga.addEventListener("keypress",d=>{var g;d.key==="Enter"&&(d.preventDefault(),(g=document.getElementById("preset-builder-category"))==null||g.focus())});const se=document.getElementById("preset-builder-category"),me=document.getElementById("category-autocomplete");if(se&&me){const d=()=>{const b=se.value,C=b.lastIndexOf(","),W=(C>=0?b.substring(C+1):b).trim().toUpperCase(),Jn=ro(),Xn=W?Jn.filter(Nt=>Nt.includes(W)):Jn;Xn.length>0?(me.innerHTML=Xn.map(Nt=>`<div class="category-autocomplete-item" data-category="${Nt}">${Nt}</div>`).join(""),me.style.display="block"):me.style.display="none"},g=b=>{const C=se.value,W=C.lastIndexOf(",");W>=0?se.value=C.substring(0,W+1)+" "+b+", ":se.value=b+", ",me.style.display="none",se.focus()};se.addEventListener("input",d),se.addEventListener("focus",d),me.addEventListener("click",b=>{if(b.target.classList.contains("category-autocomplete-item")){const C=b.target.getAttribute("data-category");g(C)}}),document.addEventListener("click",b=>{!se.contains(b.target)&&!me.contains(b.target)&&(me.style.display="none")}),se.addEventListener("keypress",b=>{var C;b.key==="Enter"&&(b.preventDefault(),me.style.display="none",(C=document.getElementById("preset-builder-template"))==null||C.focus())})}const Ya=document.getElementById("preset-builder-save");Ya&&Ya.addEventListener("click",lo);const za=document.getElementById("preset-builder-clear");za&&za.addEventListener("click",ta);const Va=document.getElementById("preset-builder-delete");Va&&Va.addEventListener("click",co),document.querySelectorAll(".chip-section-header").forEach(d=>{d.addEventListener("click",()=>{const g=d.getAttribute("data-section"),b=document.getElementById("section-"+g),C=b.style.display==="block";document.querySelectorAll(".chip-section-content").forEach(W=>{W.style.display="none"}),document.querySelectorAll(".chip-section-header").forEach(W=>{W.classList.remove("expanded")}),C||(b.style.display="block",d.classList.add("expanded"))})}),document.querySelectorAll(".preset-chip").forEach(d=>{d.addEventListener("click",g=>{const b=g.target.getAttribute("data-text"),C=document.getElementById("preset-builder-prompt"),W=C.value;W.trim()?C.value=W+" "+b:C.value=b,C.scrollTop=C.scrollHeight})});const Wa=document.getElementById("preset-builder-quality");Wa&&Wa.addEventListener("change",d=>{const g=d.target.value;if(g){const b=document.getElementById("preset-builder-prompt"),C=b.value;C.trim()?b.value=C+" "+g:b.value=g,d.target.value="",b.scrollTop=b.scrollHeight}});const qa=document.getElementById("visible-presets-filter");qa&&qa.addEventListener("input",d=>{pt=d.target.value,_e()});const Ka=document.getElementById("visible-presets-select-all");Ka&&Ka.addEventListener("click",()=>{E=m.filter(g=>!g.internal).map(g=>g.name),Me(),_e(),Yt(),N&&Ee()});const Ja=document.getElementById("visible-presets-deselect-all");Ja&&Ja.addEventListener("click",()=>{E=[],Me(),_e(),Yt(),N&&Ee()});const Xa=document.getElementById("visible-presets-jump-up");Xa&&Xa.addEventListener("click",()=>{Y=0,yt()});const _a=document.getElementById("visible-presets-jump-down");_a&&_a.addEventListener("click",()=>{const d=document.getElementById("visible-presets-list");if(d){const g=d.querySelectorAll(".style-item");g.length>0&&(Y=g.length-1,yt())}});const $a=document.getElementById("white-balance-settings-button");$a&&$a.addEventListener("click",Xs);const Qa=document.getElementById("white-balance-back");Qa&&Qa.addEventListener("click",Di);const Za=document.getElementById("motion-sensitivity-slider"),en=document.getElementById("motion-sensitivity-value");if(Za&&en){const d=["Very Low","Low","Medium","High","Very High"];Za.addEventListener("input",g=>{const b=parseInt(g.target.value);en.textContent=d[b-1],Ze=50-b*10,Mt(),Gi()})}const tn=document.getElementById("motion-continuous-enabled");tn&&tn.addEventListener("change",d=>{ze=d.target.checked,Mt()});const an=document.getElementById("motion-cooldown-slider"),nn=document.getElementById("motion-cooldown-value");an&&nn&&an.addEventListener("input",d=>{et=parseInt(d.target.value),nn.textContent=`${et}s`,Mt()});const sn=document.getElementById("motion-start-delay-slider"),on=document.getElementById("motion-start-delay-value");sn&&on&&sn.addEventListener("input",d=>{const g=parseInt(d.target.value);tt=mt[g].seconds,on.textContent=mt[g].label,Mt()});const rn=document.getElementById("no-magic-toggle-button");rn&&rn.addEventListener("click",po);const ln=document.getElementById("tutorial-button");ln&&ln.addEventListener("click",yo);const cn=document.getElementById("tutorial-back");cn&&cn.addEventListener("click",bo),document.querySelectorAll(".glossary-item").forEach(d=>{d.addEventListener("click",()=>{const g=d.getAttribute("data-section");To(g)})});const dn=document.getElementById("back-to-glossary");dn&&dn.addEventListener("click",Yi);const hn=document.getElementById("master-prompt-enabled");hn&&hn.addEventListener("change",d=>{we=d.target.checked;const g=document.getElementById("master-prompt-text");g&&(g.disabled=!we),jt(),Wt()});const un=document.getElementById("master-prompt-text");un&&un.addEventListener("input",d=>{Z=d.target.value;const g=document.getElementById("master-prompt-char-count");g&&(g.textContent=Z.length),jt(),Wt()});const mn=document.getElementById("style-filter");let oa=null;mn&&mn.addEventListener("input",d=>{Ae=d.target.value,oa&&clearTimeout(oa),oa=setTimeout(()=>{Ee()},150)});const gn=document.getElementById("burst-count-slider"),ra=document.getElementById("burst-speed-slider");gn&&gn.addEventListener("input",d=>{M=parseInt(d.target.value),document.getElementById("burst-count-value").textContent=M;const g=parseInt(ra.value);si(M,g),Vt(),Re&&(y.textContent=`Burst mode ON (${M} photos) • ${m[T].name}`)}),ra&&ra.addEventListener("input",d=>{const g=parseInt(d.target.value);wt=Qe[g].delay,document.getElementById("burst-speed-value").textContent=Qe[g].label,si(M,g),Vt()});const pn=document.getElementById("timer-delay-slider"),fn=document.getElementById("timer-delay-value");pn&&fn&&pn.addEventListener("input",d=>{const g=parseInt(d.target.value)-1;de=pi[g],fn.textContent=de,ya(),ut()});const yn=document.getElementById("timer-repeat-enabled");yn&&yn.addEventListener("change",d=>{We=d.target.checked,ya(),ut()});const la=document.getElementById("timer-repeat-interval-input"),ca=document.getElementById("timer-repeat-interval-unit");if(la&&ca){const d=()=>{const g=parseInt(la.value)||1,b=parseInt(ca.value);q=g*b,ya(),ut()};la.addEventListener("input",d),ca.addEventListener("change",d)}Co(),jo(),go(),fo();const bn=document.getElementById("reset-button");bn&&bn.addEventListener("click",na);const Tn=document.getElementById("camera-button");Tn&&Tn.addEventListener("click",No);const En=document.getElementById("close-editor");En&&En.addEventListener("click",xa);const wn=document.getElementById("save-style");wn&&wn.addEventListener("click",ir);const In=document.getElementById("delete-style");In&&In.addEventListener("click",sr),Be=document.getElementById("connection-status"),Xe=document.getElementById("queue-status"),le=document.getElementById("sync-button"),le&&le.addEventListener("click",Tt),Xe&&Xe.addEventListener("click",Ma);const vn=document.getElementById("close-queue-manager");vn&&vn.addEventListener("click",Uo);const kn=document.getElementById("sync-all");kn&&kn.addEventListener("click",Tt);const An=document.getElementById("clear-queue");An&&An.addEventListener("click",qi);const Rn=document.getElementById("gallery-button");Rn&&Rn.addEventListener("click",ne);const On=document.getElementById("close-gallery");On&&On.addEventListener("click",ts);const Sn=document.getElementById("close-viewer");Sn&&Sn.addEventListener("click",ss);const Nn=document.getElementById("delete-viewer-image");Nn&&Nn.addEventListener("click",os);const Cn=document.getElementById("gallery-start-date-btn"),da=document.getElementById("gallery-start-date");Cn&&da&&(Cn.addEventListener("click",()=>{da.showPicker()}),da.addEventListener("change",d=>{dt=d.target.value||null,ti("start",dt),pa()}));const Ln=document.getElementById("gallery-end-date-btn"),ha=document.getElementById("gallery-end-date");Ln&&ha&&(Ln.addEventListener("click",()=>{ha.showPicker()}),ha.addEventListener("change",d=>{ht=d.target.value||null,ti("end",ht),pa()}));const Mn=document.getElementById("gallery-sort-order");Mn&&Mn.addEventListener("change",d=>{gt=d.target.value;try{localStorage.setItem(Ii,gt)}catch(g){console.error("Failed to save sort order:",g)}pa()});const jn=document.getElementById("prev-page");jn&&jn.addEventListener("click",ns);const xn=document.getElementById("next-page");xn&&xn.addEventListener("click",as);const Pn=document.getElementById("load-preset-button");Pn&&Pn.addEventListener("click",rs);const Dn=document.getElementById("multi-preset-button");Dn&&Dn.addEventListener("click",()=>{if(J>=0){const d=L[J].id;Bs(d)}});const Un=document.getElementById("close-preset-selector");Un&&Un.addEventListener("click",Ft);const Bn=document.getElementById("preset-filter");Bn&&Bn.addEventListener("input",d=>{Bt=d.target.value,kt()});const Hn=document.getElementById("preset-selector-jump-up");Hn&&Hn.addEventListener("click",()=>{x=0,Ve()});const Fn=document.getElementById("preset-selector-jump-down");Fn&&Fn.addEventListener("click",()=>{const d=document.getElementById("preset-list");if(d){const g=d.querySelectorAll(".preset-item");g.length>0&&(x=g.length-1,Ve())}});const Gn=document.getElementById("magic-button");Gn&&Gn.addEventListener("click",Ms);const Yn=document.getElementById("batch-mode-toggle");Yn&&Yn.addEventListener("click",Gt);const zn=document.getElementById("batch-select-all");zn&&zn.addEventListener("click",js);const Vn=document.getElementById("batch-deselect-all");Vn&&Vn.addEventListener("click",xs);const Wn=document.getElementById("batch-cancel");Wn&&Wn.addEventListener("click",Gt);const qn=document.getElementById("batch-apply-preset");qn&&qn.addEventListener("click",Ps);const Kn=document.getElementById("batch-delete");Kn&&Kn.addEventListener("click",Us),$t().then(async()=>{localStorage.getItem("r1_gallery_index")?(console.log("Migrating old gallery data..."),await Qi()):await Qt()}).catch(d=>{console.error("Failed to initialize database:",d)}),Fs()});window.removeFromQueue=Bo;window.previewQueueItem=Ho;window.clearQueue=qi;console.log("AI Camera Styles app initialized!");
